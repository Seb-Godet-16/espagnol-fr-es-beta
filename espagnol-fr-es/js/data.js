...
{id:'num',level:1,emoji:'🔢',name:'Los Números',sub:'Del cero al dos mil / Zéro à deux mille',
 ...
 {id:'col',level:1,emoji:'🎨',name:'Los Colores',sub:'Rojo, azul, verde… / Les couleurs',
   words:[
    ...
    {es:'Naranja',fr:'Orange',em:'🧡',
     variants:{MX:'Anaranjado',AR:'Naranja / Anaranjado',CO:'Anaranjado',CL:'Naranja / Anaranjado',PE:'Anaranjado'}},
    {es:'Blanco',fr:'Blanc',em:'🤍'},
    {es:'Negro',fr:'Noir',em:'🖤'},
    {es:'Rosa',fr:'Rose',em:'🩷',
     variants:{MX:'Rosado',AR:'Rosado',CO:'Rosado',CL:'Rosado',PE:'Rosado'}},
    {es:'Morado / Violeta',fr:'Violet (morado=foncé, violeta=clair)',em:'💜'},
    {es:'Marrón',fr:'Marron',em:'🤎',
     variants:{MX:'Café',AR:'Marrón',CO:'Café',CL:'Café',PE:'Marrón / Café'}},
    {es:'Gris',fr:'Gris',em:'🩶'}
   ],
   quiz10:[
 ...
 // Préparation
  ...
  {es:'La maleta',fr:'La valise',em:'🧳',
   variants:{AR:'La valija',UY:'La valija'}},
  {es:'El equipaje',fr:'Les bagages',em:'🎒'},
  {es:'El billete',fr:'Le billet',em:'🎫',
   variants:{MX:'El boleto',AR:'El boleto / El pasaje',CO:'El boleto / El pasaje',VE:'El boleto / El pasaje',PE:'El boleto / El pasaje',CL:'El boleto / El pasaje'}},
...
{id:'rest',level:1,emoji:'🍽️',name:'El Restaurante',sub:'Menú, cuenta, mesa… / Au restaurant',
 words:[
  ...
  {es:'El camarero / La camarera',fr:'Le serveur / La serveuse',em:'🧑‍🍳',
   variants:{MX:'El mesero / La mesera',AR:'El mozo / La moza',CO:'El mesero / La mesera',VE:'El mesero / La mesera',PE:'El mesero / La mesera',CL:'El mesero / La mesera'}},
  ...
  {es:'El bocadillo',fr:'Le sandwich',em:'🥖',
   variants:{MX:'El sándwich / El lonche',AR:'El sándwich',CO:'El sándwich',VE:'El sándwich',PE:'El sándwich',CL:'El sándwich / El sánguche'}},
...
{id:'trans',level:1,emoji:'🚌',name:'Los Transportes',sub:'Metro, tren, coche… / Les transports',
 words:[
  ...
  {es:'El autobús / el bus',fr:'Le bus',em:'🚌',
   variants:{MX:'El camión / El autobús',AR:'El colectivo',CO:'El bus / La buseta',VE:'El autobús / La buseta',PE:'El micro / La combi',CL:'La micro'}},
  ...
  {es:'El coche',fr:'La voiture',em:'🚗',
   variants:{MX:'El carro',CO:'El carro',VE:'El carro',PE:'El carro',AR:'El auto',UY:'El auto',CL:'El auto'}},
  {es:'La moto',fr:'La moto',em:'🏍️'},
  {es:'La bicicleta / La bici',fr:'Le vélo',em:'🚴'},
  // Titre de transport
  {es:'El billete',fr:'Le billet',em:'🎫',
   variants:{MX:'El boleto',AR:'El boleto',CO:'El pasaje / El boleto',VE:'El billete / El pasaje',PE:'El boleto / El pasaje',CL:'El boleto'}},
 ],
 quiz10:[
...
{id:'objets',level:1,emoji:'🔑',name:'Objetos del Día',sub:'Teléfono, llaves… / Objets du quotidien',
 words:[
  ...
  {es:'El móvil',fr:'Le portable',em:'📱',
   variants:{MX:'El celular',AR:'El celular',CO:'El celular',VE:'El celular',PE:'El celular',CL:'El celular'}},
  {es:'El ordenador',fr:'L\'ordinateur',em:'💻',
   variants:{MX:'La computadora',AR:'La computadora',CO:'El computador / La computadora',VE:'El computador',PE:'La computadora',CL:'El computador'}},
  ...
  {es:'La cartera / El monedero',fr:'Le portefeuille / le porte-monnaie',em:'👛',
   variants:{MX:'La billetera / El monedero',AR:'La billetera',CO:'La billetera',VE:'La billetera',PE:'La billetera',CL:'La billetera'}},
  {es:'La mochila',fr:'Le sac à dos',em:'🎒'},
  {es:'Las gafas',fr:'Les lunettes',em:'👓',
   variants:{MX:'Los lentes',AR:'Los anteojos / Lentes',CO:'Los lentes',VE:'Los lentes',PE:'Los lentes',CL:'Los lentes'}},
  {es:'El paraguas',fr:'Le parapluie',em:'☂️'},
  // Papeterie
  {es:'El papel',fr:'Le papier',em:'📄'},
  {es:'El bolígrafo / El boli',fr:'Le stylo / le bic',em:'🖊️',
   variants:{MX:'La pluma',AR:'La lapicera / El birome',CO:'El lapicero',VE:'El bolígrafo / El lapicero',PE:'El lapicero',CL:'El lápiz pasta'}},
...
{id:'log',level:1,emoji:'🏠',name:'La Vivienda',sub:'Salón, cocina… / Le logement',
 words:[
  ...
  {es:'El piso / El apartamento',fr:'L\'appartement',em:'🏢',
   variants:{MX:'El departamento',AR:'El departamento',CO:'El apartamento',VE:'El apartamento',PE:'El departamento',CL:'El departamento'}},
  // Pièces principales
...
{id:'muebles_equipamiento', level:1, emoji:'🪑', name:'Muebles y Equipamiento', sub:'Sofá, electrodomésticos, baño… / Meubles et équipements',
 words:[
  ...
  {es:'El frigorífico / La nevera',fr:'Le réfrigérateur',em:'🧊',
   variants:{MX:'El refrigerador',AR:'La heladera',CO:'La nevera / El refrigerador',VE:'La nevera',PE:'El refrigerador',CL:'El refrigerador / La refrí'}},
  ...
  {es:'El lavabo',fr:'Le lavabo',em:'🚰',
   variants:{MX:'El lavamanos',AR:'El lavatorio / La bacha',CO:'El lavamanos',VE:'El lavamanos',PE:'El lavamanos',CL:'El lavamanos'}},
  {es:'La bañera',fr:'La baignoire',em:'🛁',
   variants:{AR:'La bañadera',UY:'La bañadera'}},
  ...
  {q:'¿Qué significa "El escritorio"?',opts:['L\'armoire','Le lit','Le bureau','La table'],ans:2}
   ...
   words:[
    ...
    {es:'Enfadado / Enfadada',fr:'Fâché / Fâchée',em:'😠',
     variants:{MX:'Enojado / Enojada',AR:'Enojado / Enojada',CO:'Enojado / Enojada',VE:'Enojado / Enojada',PE:'Enojado / Enojada',CL:'Enojado / Enojada'}},
    ...
    {es:'Agobiado / Agobiada',fr:'Stressé / Stressée',em:'😰',
     variants:{MX:'Abrumado / Abrumada',AR:'Agobiado / Abrumado',CO:'Abrumado / Abrumada',CL:'Estresado / Agobiado',PE:'Abrumado / Abrumada'}},
    ...
    {es:'¡Qué guay! / ¡Mola!',fr:'C\'est super ! / C\'est cool !',em:'🌟',
     variants:{MX:'¡Qué padre! / ¡Qué chido!',AR:'¡Qué copado! / ¡Qué bueno!',CO:'¡Qué chévere! / ¡Qué bacano!',VE:'¡Qué chévere!',PE:'¡Qué chévere! / ¡Qué paja!',CL:'¡Qué bacán!'}}
   ],
   quiz10:[
 ...
 {id:'fam',level:1,emoji:'👨‍👩‍👧',name:'La Familia',sub:'Papá, mamá, hijo… / La famille',
   words:[
    ...
    {es:'El tío / la tía',fr:'L\'oncle / La tante (aussi : mec / nana en argot)',em:'👨/👩',
     variants:{MX:'El güey / La chava',AR:'El chabón / La mina',CO:'El parce / La vieja',CL:'El gallo / La galla',PE:'El pata / La flaca'}}
   ],
   quiz10:[
 ...
 {id:'ocio', level:1, emoji:'⛰️', name:'El Ocio', sub:'Deporte, senderismo, lectura… / Les loisirs',
  words:[
    ...
    {es:'El senderismo',fr:'La randonnée',em:'🥾',
     variants:{MX:'El excursionismo',AR:'El trekking',CO:'El excursionismo / El trekking',CL:'El trekking',PE:'El trekking'}},
 ...
 {id:'pays',level:1,emoji:'🌍',name:'Los Países',sub:'Francia, España… / Les pays',
   words:[
    ...
    {es:'Estados Unidos',fr:'Les États-Unis',em:'🇺🇸',
     variants:{MX:'EE. UU.',AR:'EE. UU.',CO:'EE. UU.',VE:'EE. UU.',PE:'EE. UU.',CL:'EE. UU.'}},
...
{id:'nour',level:1,emoji:'🍽️',name:'La Nourriture',sub:'Pain, légumes, llapingachos… / La comida',
 words:[
   {es:'Las frutas',fr:'Les fruits',em:'🍉'},
   {es:'Las verduras',fr:'Les légumes',em:'🥦'},
   {es:'El pan',fr:'Le pain',em:'🍞'},
   ...
   {es:'La mantequilla',fr:'Le beurre',em:'🧈',
    variants:{AR:'La manteca',UY:'La manteca'}},
   {es:'La manzana',fr:'La pomme',em:'🍎'},
   {es:'El plátano',fr:'La banane',em:'🍌',
    variants:{VE:'El cambur',PR:'El guineo',AR:'La banana'}},
   {es:'La naranja',fr:'L\'orange',em:'🍊'},
   {es:'El limón',fr:'Le citron',em:'🍋'},
   {es:'La fresa',fr:'La fraise',em:'🍓',
    variants:{AR:'La frutilla',UY:'La frutilla',CL:'La frutilla'}},
 ...
 quiz10:[
   ...
   {q:'¿Cómo se dice "El limón" en français?',opts:['Le citron','L\'œuf','Les fruits','Le fromage'],ans:0},
   ...
   {q:'¿Cómo se dice "El chocolate" en français?',opts:['Le sel','Le chocolat','La tomate','Le poulet'],ans:1},
   {q:'¿Cómo se dice "La sal" en français?',opts:['Le sel','La pastèque','La carotte','Le chorizo'],ans:0},
   {q:'¿Cómo se dice "El plátano" en français?',opts:['La pastèque','Les fruits','La banane','La pomme de terre'],ans:2},
   {q:'¿Cómo se dice "La sandía" en français?',opts:['Le pain','Le sel','La carotte','La pastèque'],ans:3},
   {q:'¿Cómo se dice "La naranja" en français?',opts:['Le poivre','Le poulet','L\'orange','La carotte'],ans:2},
   ...
   {q:'¿Cómo se dice "Las fruits" en français?',opts:['La fraise','L\'orange','Les fruits','La tomate'],ans:2}
 ]},
...
{id:'rest',level:1,emoji:'🍽️',name:'Au Restaurant',sub:'Menu, addition, table… / El restaurante',
 words:[
   ...
   {es:'El entrante',fr:'L\'entrée',em:'🥗',
    variants:{MX:'La entrada',AR:'La entrada',CO:'La entrada',VE:'La entrada',PE:'La entrada',CL:'La entrada'}},
   {es:'El plato principal',fr:'Le plat principal',em:'🍖'},
   {es:'El postre',fr:'Le dessert',em:'🍮'},
...
{id:'muebles_equipamiento',level:1,emoji:'🪑',name:'Meubles et équipements',sub:'Canapé, électroménager, salle de bain… / Muebles y equipamiento',
 words:[
   ...
   {es:'La nevera / El frigorífico',fr:'Le réfrigérateur',em:'🧊',
    variants:{MX:'El refrigerador',AR:'La heladera',CO:'La nevera / El refrigerador',VE:'La nevera',PE:'El refrigerador',CL:'El refrigerador / La rrefrí'}},
   {es:'El horno',fr:'Le four',em:'🔥'},
   {es:'El microondas',fr:'Le micro-ondes',em:'🔲♨️'},
   {es:'El fregadero',fr:'L\'évier',em:'🚰',
    variants:{MX:'El fregadero / La tarja',AR:'La pileta de la cocina',CO:'El lavaplatos',VE:'El fregadero',PE:'El lavadero'}},
...
{id:'emot',level:1,emoji:'😄',name:'Les Émotions',sub:'Content, fatigué… / Las emociones',
 words:[
  ...
  {es:'Cabreado / Cabreada',fr:'Énervé / Énervée (coloquial España)',em:'😠',
   variants:{MX:'Encabronado / Encabronada',AR:'Caliente / Chinchudo',CO:'Berraco / Berraca',CL:'Choreado / Choreada',PE:'Asado / Asada'}},
  {es:'Tener miedo',fr:'Avoir peur / Avoir peur',em:'😨'},
  {es:'Enfermo / Enferma',fr:'Malade / Malade',em:'🤒'},
  {es:'Pachucho / Pachucha',fr:'Pas très bien / Malade (coloquial afectuoso)',em:'🤒',
   variants:{MX:'Malito / Malita',AR:'Decaído / Decaída',CO:'Malito / Malita',CL:'Decaído / Decaída',PE:'Malito / Malita'}},
  {es:'Preocupado / Preocupada',fr:'Inquiet / Inquiète',em:'😟'},
  {es:'Estresado / Estresada',fr:'Stressé / Stressée',em:'😰'},
  {es:'Agobiado / Agobiada',fr:'Stressé / Stressée',em:'😰',
   variants:{MX:'Abrumado / Abrumada',AR:'Agobiado / Abrumado',CO:'Abrumado / Abrumada',CL:'Estresado / Agobiado',PE:'Abrumado / Abrumada'}},
...
{id:'anim',level:1,emoji:'🐘',name:'Les Animaux',sub:'Chien, chat, perroquet… / Los animales',
 ...
 words:[
   ...
   {es:'El árbol',fr:'L\'arbre',em:'🌳'},
   {es:'La hoja',fr:'La feuille',em:'🍃'},
   {es:'La hierba / El césped',fr:'L\'herbe',em:'🌱'},
 ...
 quiz10:[
   ...
   {q:'¿Cómo se dice "La flor" en francés?',opts:['La rose','La pelouse','La forêt','La fleur'],ans:3},
   {q:'¿Cómo se dice "El jardín" en francés?',opts:['Le jardin','La fleur','La pelouse','La feuille'],ans:0},
   {q:'¿Cómo se dice "La hoja" en francés?',opts:['La feuille','L\'herbe','La forêt','La pelouse'],ans:0}
 ]},
];
