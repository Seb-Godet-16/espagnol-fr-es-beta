...
{id:'nour',level:1,emoji:'🍽️',name:'La Nourriture',sub:'Pain, légumes, llapingachos… / La comida',words:[{es:'Las frutas',fr:'Les fruits',em:'🍉'},{es:'Las verduras',fr:'Les légumes',em:'🥦'},{es:'El pan',fr:'Le pain',em:'🍞'},{es:'El arroz',fr:'Le riz',em:'🍚'},{es:'La pasta',fr:'Les pâtes',em:'🍝'},{es:'La patata / Las patatas fritas',fr:'La pomme de terre / Les frites',em:'🥔'},{es:'La carne',fr:'La viande',em:'🥩'},{es:'El pollo',fr:'Le poulet',em:'🍗'},{es:'El pescado',fr:'Le poisson',em:'🐟'},{es:'El jamón',fr:'Le jambon',em:'🥩'},{es:'El chorizo',fr:'Le chorizo',em:'🌭'},{es:'El huevo',fr:'L\'œuf',em:'🥚'},{es:'El queso',fr:'Le fromage',em:'🧀'},{es:'La mantequilla',fr:'Le beurre',em:'🧈'},{es:'La manzana',fr:'La pomme',em:'🍎'},{es:'El plátano',fr:'La banane',em:'🍌'},{es:'La naranja',fr:'L\'orange',em:'🍊'},{es:'El limón',fr:'Le citron',em:'🍋'},{es:'La fresa',fr:'La fraise',em:'🍓'},{es:'La sandía',fr:'La pastèque',em:'🍉'},{es:'El tomate',fr:'La tomate',em:'🍅'},{es:'La zanahoria',fr:'La carotte',em:'🥕'},{es:'La cebolla',fr:'L\'oignon',em:'🧅'},{es:'El ajo',fr:'L\'ail',em:'🧄'},{es:'El pepino',fr:'Le concombre',em:'🥒'},{es:'La ensalada',fr:'La salade',em:'🥗'},{es:'El aceite',fr:'L\'huile',em:'🫒'},{es:'La sal',fr:'Le sel',em:'🧂'},{es:'La pimienta',fr:'Le poivre',em:'🌶️'},{es:'La miel',fr:'Le miel',em:'🍯'},{es:'El chocolate',fr:'Le chocolat',em:'🍫'}],quiz10:[{q:'¿Cómo se dice "La pimienta" en francés?',opts:['La pastèque','Le pain','Le citron','Le poivre'],ans:3},{q:'¿Cómo se dice "El limón" en francés?',opts:['Le citron','L\'œuf','Les fruits','Le fromage'],ans:0},{q:'¿Cómo se dice "El arroz" en francés?',opts:['Le riz','Le fromage','L\'huile','Le miel'],ans:0},{q:'¿Cómo se dice "La fresa" en francés?',opts:['La fraise','Le chorizo','Le poivre','La banane'],ans:0},{q:'¿Cómo se dice "El chocolate" en francés?',opts:['Le sel','Le chocolat','La tomate','Le poulet'],ans:1},{q:'¿Cómo se dice "La sal" en francés?',opts:['Le sel','La pastèque','La carotte','Le chorizo'],ans:0},{q:'¿Cómo se dice "El plátano" en francés?',opts:['La pastèque','Les fruits','La banane','La pomme de terre'],ans:2},{q:'¿Cómo se dice "La sandía" en francés?',opts:['Le pain','Le sel','La carotte','La pastèque'],ans:3},{q:'¿Cómo se dice "La naranja" en francés?',opts:['Le poivre','Le poulet','L\'orange','La carotte'],ans:2},{q:'¿Cómo se dice "La mantequilla" en francés?',opts:['La fraise','Le poivre','Le beurre','Les fruits'],ans:2},{q:'¿Cómo se dice "La cebolla" en francés?',opts:['L\'oignon','Les fruits','La banane','Le poulet'],ans:0},{q:'¿Cómo se dice "Las frutas" en francés?',opts:['La fraise','L\'orange','Les fruits','La tomate'],ans:2}]},
{id:'bois',level:1,emoji:'🥤',name:'Les Boissons',sub:'Eau, café, jus… / Las bebidas',words:[{es:'El agua',fr:'L\'eau',em:'💧'},{es:'El agua con gas',fr:'L\'eau gazeuse',em:'🫧'},{es:'La leche',fr:'Le lait',em:'🥛'},{es:'El zumo (de naranja)',fr:'Le jus (d\'orange)',em:'🍊'},{es:'El refresco',fr:'Le soda',em:'🥤'},{es:'El café solo',fr:'Le café noir',em:'☕'},{es:'El café con leche',fr:'Le café au lait',em:'☕'},{es:'El café de filtro',fr:'Le café filtre',em:'☕'},{es:'El té',fr:'Le thé',em:'🍵'},{es:'El vino (tinto / blanco)',fr:'Le vin (rouge / blanc)',em:'🍷'},{es:'La cerveza',fr:'La bière',em:'🍺'},{es:'La sidra',fr:'Le cidre',em:'🍾'}],quiz10:[{q:'¿Cómo se dice "El café solo" en francés?',opts:['Le soda','Le cidre','Le café noir','Le café filtre'],ans:2},{q:'¿Cómo se dice "La sidra" en francés?',opts:['Le lait','Le jus','Le café noir','Le cidre'],ans:3},{q:'¿Cómo se dice "El agua" en francés?',opts:['Le thé','Le cidre','Le soda','L\'eau'],ans:3},{q:'¿Cómo se dice "El agua con gas" en francés?',opts:['Le cidre','Le jus','Le thé','L\'eau gazeuse'],ans:3},{q:'¿Cómo se dice "El café de filtro" en francés?',opts:['Le café filtre','Le café au lait','Le cidre','La bière'],ans:0},{q:'¿Cómo se dice "La cerveza" en francés?',opts:['La bière','Le lait','Le jus','Le café au lait'],ans:0},{q:'¿Cómo se dice "El té" en francés?',opts:['La bière','L\'eau','Le café filtre','Le thé'],ans:3},{q:'¿Cómo se dice "El zumo" en francés?',opts:['Le jus','Le lait','Le café au lait','Le thé'],ans:0}]},
{id:'num',level:1,emoji:'🔢',name:'Les Nombres',sub:'De zéro à deux mille / Del cero al dos mil',words:[{es:'Cero',fr:'Zéro',em:'0️⃣'},{es:'Uno',fr:'Un',em:'1️⃣'},{es:'Dos',fr:'Deux',em:'2️⃣'},{es:'Tres',fr:'Trois',em:'3️⃣'},{es:'Cuatro',fr:'Quatre',em:'4️⃣'},{es:'Cinco',fr:'Cinq',em:'5️⃣'},{es:'Seis',fr:'Six',em:'6️⃣'},{es:'Siete',fr:'Sept',em:'7️⃣'},{es:'Ocho',fr:'Huit',em:'8️⃣'},{es:'Nueve',fr:'Neuf',em:'9️⃣'},{es:'Diez',fr:'Dix',em:'🔟'},{es:'Once',fr:'Onze',em:'1️⃣1️⃣'},{es:'Doce',fr:'Douze',em:'1️⃣2️⃣'},{es:'Trece',fr:'Treize',em:'1️⃣3️⃣'},{es:'Catorce',fr:'Quatorze',em:'1️⃣4️⃣'},{es:'Quince',fr:'Quinze',em:'1️⃣5️⃣'},{es:'Dieciséis',fr:'Seize',em:'1️⃣6️⃣'},{es:'Diecisiete',fr:'Dix-sept',em:'1️⃣7️⃣'},{es:'Dieciocho',fr:'Dix-huit',em:'1️⃣8️⃣'},{es:'Diecinueve',fr:'Dix-neuf',em:'1️⃣9️⃣'},{es:'Veinte',fr:'Vingt',em:'2️⃣0️⃣'},{es:'Treinta',fr:'Trente',em:'3️⃣0️⃣'},{es:'Cuarenta',fr:'Quarante',em:'4️⃣0️⃣'},{es:'Cincuenta',fr:'Cinquante',em:'5️⃣0️⃣'},{es:'Sesenta',fr:'Soixante',em:'6️⃣0️⃣'},{es:'Setenta',fr:'Soixante-dix',em:'7️⃣0️⃣'},{es:'Ochenta',fr:'Quatre-vingts',em:'8️⃣0️⃣'},{es:'Noventa',fr:'Quatre-vingt-dix',em:'9️⃣0️⃣'},{es:'Cien / ciento',fr:'Cent (ciento delante de un número : ciento veinte = 120)',em:'1️⃣0️⃣0️⃣'},{es:'Doscientos / Doscientas',fr:'Deux cents',em:'2️⃣0️⃣0️⃣'},{es:'Trescientos / Trescientas',fr:'Trois cents',em:'3️⃣0️⃣0️⃣'},{es:'Cuatrocientos / Cuatrocientas',fr:'Quatre cents',em:'4️⃣0️⃣0️⃣'},{es:'Quinientos / Quinientas',fr:'Cinq cents',em:'5️⃣0️⃣0️⃣'},{es:'Seiscientos / Seiscientas',fr:'Six cents',em:'6️⃣0️⃣0️⃣'},{es:'Setecientos / Setecientas',fr:'Sept cents',em:'7️⃣0️⃣0️⃣'},{es:'Ochocientos / Ochocientas',fr:'Huit cents',em:'8️⃣0️⃣0️⃣'},{es:'Novecientos / Novecientas',fr:'Neuf cents',em:'9️⃣0️⃣0️⃣'},{es:'Mil',fr:'Mille',em:'1️⃣0️⃣0️⃣0️⃣'},{es:'Dos mil',fr:'Deux mille (mille es invariable)',em:'2️⃣0️⃣0️⃣0️⃣'}],quiz10:[{q:'¿Cómo se dice "Dos mil" en francés?',opts:['Cinquante','Deux mille','Quatorze','Huit cents'],ans:1},{q:'¿Cómo se dice "Trescientos" en francés?',opts:['Treize','Dix-neuf','Trente','Trois cents'],ans:3},{q:'¿Cómo se dice "Ocho" en francés?',opts:['Six','Seize','Zéro','Huit'],ans:3},{q:'¿Cómo se dice "Diecinueve" en francés?',opts:['Un','Quarante','Soixante-dix','Dix-neuf'],ans:3},{q:'¿Cómo se dice "Dieciséis" en francés?',opts:['Onze','Quatre-vingt-dix','Deux mille','Seize'],ans:3},{q:'¿Cómo se dice "Cinco" en francés?',opts:['Cinq','Deux','Dix','Quatre'],ans:0},{q:'¿Cómo se dice "Noventa" en francés?',opts:['Huit cents','Quinze','Quatre-vingt-dix','Sept cents'],ans:2},{q:'¿Cómo se dice "Novecientos" en francés?',opts:['Quatre-vingts','Neuf cents','Trente','Trois'],ans:1},{q:'¿Cómo se dice "Setecientos" en francés?',opts:['Sept cents','Soixante','Deux mille','Zéro'],ans:0},{q:'¿Cómo se dice "Cero" en francés?',opts:['Quatre cents','Cinq','Zéro','Sept'],ans:2},{q:'¿Cómo se dice "Catorce" en francés?',opts:['Quatorze','Cinquante','Deux','Soixante-dix'],ans:0},{q:'¿Cómo se dice "Quince" en francés?',opts:['Onze','Quinze','Treize','Dix-huit'],ans:1}]},
{id:'col',level:1,emoji:'🎨',name:'Les Couleurs',sub:'Rouge, bleu, vert… / Los colores',words:[{es:'Rojo',fr:'Rouge',em:'❤️'},{es:'Azul',fr:'Bleu',em:'💙'},{es:'Verde',fr:'Vert',em:'💚'},{es:'Amarillo',fr:'Jaune',em:'💛'},{es:'Naranja',fr:'Orange',em:'🧡'},{es:'Blanco',fr:'Blanc',em:'🤍'},{es:'Negro',fr:'Noir',em:'🖤'},{es:'Rosa',fr:'Rose',em:'🩷'},{es:'Morado / Violeta',fr:'Violet',em:'💜'},{es:'Marrón',fr:'Marron',em:'🤎'},{es:'Gris',fr:'Gris',em:'🩶'}],quiz10:[{q:'¿Cómo se dice "Amarillo" en francés?',opts:['Rose','Vert','Jaune','Gris'],ans:2},{q:'¿Cómo se dice "Verde" en francés?',opts:['Rose','Marron','Vert','Bleu'],ans:2},{q:'¿Cómo se dice "Azul" en francés?',opts:['Bleu','Marron','Rose','Jaune'],ans:0},{q:'¿Cómo se dice "Blanco" en francés?',opts:['Bleu','Jaune','Vert','Blanc'],ans:3},{q:'¿Cómo se dice "Morado" en francés?',opts:['Bleu','Blanc','Jaune','Violet'],ans:3},{q:'¿Cómo se dice "Gris" en francés?',opts:['Rouge','Marron','Gris','Noir'],ans:2},{q:'¿Cómo se dice "Naranja" en francés?',opts:['Bleu','Orange','Jaune','Violet'],ans:1},{q:'¿Cómo se dice "Rosa" en francés?',opts:['Rose','Orange','Vert','Rouge'],ans:0}]},
{id:'viaje',level:1,emoji:'🧳',name:'Le Voyage',sub:'Valise, hôtel, passeport… / El viaje',words:[{es:'El pasaporte',fr:'Le passeport',em:'🛂'},{es:'La maleta',fr:'La valise',em:'🧳'},{es:'El equipaje',fr:'Les bagages',em:'🎒'},{es:'El billete',fr:'Le billet',em:'🎫'},{es:'La reserva',fr:'La réservation',em:'📋'},{es:'La agencia de viajes',fr:'L\'agence de voyages',em:'🗺️'},{es:'El seguro de viaje',fr:'L\'assurance voyage',em:'📄'},{es:'El avión',fr:'L\'avion',em:'✈️'},{es:'El aeropuerto',fr:'L\'aéroport',em:'🛫'},{es:'La salida',fr:'Le départ',em:'🚪'},{es:'La llegada',fr:'L\'arrivée',em:'🛬'},{es:'La aduana',fr:'La douane',em:'🛃'},{es:'El crucero',fr:'La croisière',em:'🚢'},{es:'El hotel',fr:'L\'hôtel',em:'🏨'},{es:'La habitación doble o individual',fr:'La chambre double ou simple',em:'🛏️'},{es:'La playa',fr:'La plage',em:'🏖️'},{es:'La montaña',fr:'La montagne',em:'⛰️'},{es:'El turista',fr:'Le touriste',em:'📸'}],quiz10:[{q:'¿Cómo se dice "La maleta" en francés?',opts:['L\'aéroport','L\'arrivée','Le départ','La valise'],ans:3},{q:'¿Cómo se dice "La aduana" en francés?',opts:['Le passeport','La montaña','La douane','La plage'],ans:2},{q:'¿Cómo se dice "La playa" en francés?',opts:['La réservation','La valise','La plage','L\'hôtel'],ans:2},{q:'¿Cómo se dice "El turista" en francés?',opts:['Le touriste','La réservation','L\'agence de voyages','La montaña'],ans:0},{q:'¿Cómo se dice "El billete" en francés?',opts:['Le billet','La chambre double ou simple','Les bagages','L\'arrivée'],ans:0},{q:'¿Cómo se dice "El avión" en francés?',opts:['La valise','L\'arrivée','La croisière','L\'avion'],ans:3},{q:'¿Cómo se dice "El seguro de viaje" en francés?',opts:['L\'avion','L\'assurance voyage','La chambre double ou simple','Le départ'],ans:1},{q:'¿Cómo se dice "La llegada" en francés?',opts:['L\'aéroport','La réservation','Le touriste','L\'arrivée'],ans:3}]},
{id:'rest',level:1,emoji:'🍽️',name:'Au Restaurant',sub:'Menu, addition, table… / El restaurante',words:[{es:'La terraza',fr:'La terrasse',em:'☀️'},{es:'La mesa',fr:'La table',em:'🪑'},{es:'¿Está libre esta mesa?',fr:'Cette table est libre ?',em:'🪑'},{es:'El camarero / La camarera',fr:'Le serveur / La serveuse',em:'🧑‍🍳'},{es:'La carta / El menú',fr:'La carte / Le menu',em:'📋'},{es:'El menú del día',fr:'Le menu du jour (déjeuner)',em:'🍱'},{es:'Pedir / Comandar',fr:'Commander',em:'🙋'},{es:'¿Qué recomienda?',fr:'Que recommandez-vous ?',em:'👨‍🍳'},{es:'Sin gluten',fr:'Sans gluten',em:'🌾'},{es:'Vegetariano / Vegetariana',fr:'Végétarien / Végétarienne',em:'🥦'},{es:'El entrante',fr:'L\'entrée',em:'🥗'},{es:'El plato principal',fr:'Le plat principal',em:'🍖'},{es:'El postre',fr:'Le dessert',em:'🍮'},{es:'El sándwich',fr:'Le sandwich',em:'🥖'},{es:'Para llevar',fr:'À emporter',em:'🥡'},{es:'La cuenta',fr:'L\'addition',em:'💶'},{es:'La propina',fr:'Le pourboire',em:'💰'},{es:'La propina está incluida',fr:'Le pourboire est inclus',em:'✅'}],quiz10:[{q:'¿Cómo se dice "La carta" en francés?',opts:['Sans gluten','La table','L\'entrée','La carte'],ans:3},{q:'¿Cómo se dice "El postre" en francés?',opts:['La carte','Végétarien','Le pourboire est inclus','Le dessert'],ans:3},{q:'¿Cómo se dice "Sin gluten" en francés?',opts:['Sans gluten','Le pourboire est inclus','Le menu du jour','Le sandwich'],ans:0},{q:'¿Cómo se dice "Pedir" en francés?',opts:['Commander','La terrasse','Sans gluten','Le sandwich'],ans:0},{q:'¿Cómo se dice "La propina está incluida" en francés?',opts:['La table','Le pourboire est inclus','L\'addition','Le sandwich'],ans:1},{q:'¿Cómo se dice "El plato principal" en francés?',opts:['Le plat principal','Le menu du jour','Sans gluten','À emporter'],ans:0},{q:'¿Cómo se dice "El entrante" en francés?',opts:['L\'entrée','Le pourboire','L\'addition','Le plat principal'],ans:0},{q:'¿Cómo se dice "Vegetariano" en francés?',opts:['Le serveur','Végétarien','Le menu du jour','L\'addition'],ans:1}]},
{id:'trans',level:1,emoji:'🚌',name:'Les Transports',sub:'Bus, train, voiture… / Los transportes',words:[{es:'El autobús / El bus',fr:'Le bus',em:'🚌'},{es:'El metro',fr:'Le métro',em:'🚇'},{es:'El tranvía',fr:'Le tramway',em:'🚊'},{es:'El tren',fr:'Le train',em:'🚂'},{es:'El avión',fr:'L\'avion',em:'✈️'},{es:'El taxi',fr:'Le taxi',em:'🚕'},{es:'El coche',fr:'La voiture',em:'🚗'},{es:'La moto',fr:'La moto',em:'🏍️'},{es:'La bicicleta / La bici',fr:'Le vélo',em:'🚴'},{es:'El billete',fr:'Le billet',em:'🎫'}],quiz10:[{q:'¿Cómo se dice "El tren" en francés?',opts:['Le billet','Le train','Le métro','Le tramway'],ans:1},{q:'¿Cómo se dice "El coche" en francés?',opts:['Le vélo','Le taxi','Le métro','La voiture'],ans:3},{q:'¿Cómo se dice "El avión" en francés?',opts:['Le bus','Le taxi','L\'avion','Le vélo'],ans:2},{q:'¿Cómo se dice "El tranvía" en francés?',opts:['Le tramway','Le taxi','Le billet','Le métro'],ans:0},{q:'¿Cómo se dice "El autobús" en francés?',opts:['La voiture','Le vélo','Le bus','Le train'],ans:2},{q:'¿Cómo se dice "La moto" en francés?',opts:['Le train','La voiture','Le métro','La moto'],ans:3},{q:'¿Cómo se dice "La bicicleta" en francés?',opts:['Le train','Le vélo','Le billet','Le taxi'],ans:1},{q:'¿Cómo se dice "El billete" en francés?',opts:['Le taxi','Le billet','Le bus','La voiture'],ans:1}]},
{id:'objets',level:1,emoji:'🔑',name:'Objets du quotidien',sub:'Téléphone, clés… / Objetos del día',words:[{es:'El teléfono',fr:'Le téléphone',em:'☎️'},{es:'El móvil',fr:'Le portable / le téléphone mobile',em:'📱'},{es:'El ordenador',fr:'L\'ordinateur',em:'💻'},{es:'El cargador',fr:'Le chargeur',em:'🔌'},{es:'El reloj de pulsera',fr:'La montre',em:'⌚'},{es:'El reloj (de pared)',fr:'L\'horloge / la pendule',em:'🕐'},{es:'Las llaves',fr:'Les clés',em:'🔑'},{es:'La cartera / El monedero',fr:'Le portefeuille / le porte-monnaie',em:'👛'},{es:'La mochila',fr:'Le sac à dos',em:'🎒'},{es:'Las gafas',fr:'Les lunettes',em:'👓'},{es:'El paraguas',fr:'Le parapluie',em:'☂️'},{es:'El papel',fr:'Le papier',em:'📄'},{es:'El bolígrafo / El boli',fr:'Le stylo / le bic',em:'🖊️'},{es:'Las tijeras',fr:'Les ciseaux',em:'✂️'},{es:'El plato',fr:'L\'assiette',em:'🍽️'},{es:'El vaso',fr:'Le verre',em:'🥛'},{es:'La taza',fr:'La tasse',em:'☕'},{es:'La cuchara',fr:'La cuillère',em:'🥄'},{es:'El tenedor',fr:'La fourchette',em:'🍴'},{es:'El cuchillo',fr:'Le couteau',em:'🔪'},{es:'La botella',fr:'La bouteille',em:'🍶'},{es:'El espejo',fr:'Le miroir',em:'🪞'},{es:'La toalla',fr:'La serviette',em:'🛁'},{es:'El jabón',fr:'Le savon',em:'🧼'},{es:'La almohada',fr:'L\'oreiller',em:'🛌'}],quiz10:[{q:'¿Cómo se dice "El vaso" en francés?',opts:['La bouteille','Les clés','L\'oreiller','Le verre'],ans:3},{q:'¿Cómo se dice "El cargador" en francés?',opts:['La bouteille','Le couteau','La fourchette','Le chargeur'],ans:3},{q:'¿Cómo se dice "El reloj (de pared)" en francés?',opts:['L\'horloge','Le sac à dos','Le couteau','Le portable'],ans:0},{q:'¿Cómo se dice "Las tijeras" en francés?',opts:['Le verre','Le papier','Le portable','Les ciseaux'],ans:3},{q:'¿Cómo se dice "La taza" en francés?',opts:['Les lunettes','Le portefeuille','La tasse','La cuillère'],ans:2},{q:'¿Cómo se dice "El ordenador" en francés?',opts:['Le savon','Les ciseaux','L\'ordinateur','Le téléphone'],ans:2},{q:'¿Cómo se dice "El móvil" en francés?',opts:['Le portefeuille','Le verre','Le portable','La tasse'],ans:2},{q:'¿Cómo se dice "El teléfono" en francés?',opts:['L\'oreiller','Le téléphone','Le verre','La fourchette'],ans:1},{q:'¿Cómo se dice "La almohada" en francés?',opts:['La serviette','Le parapluie','L\'horloge','L\'oreiller'],ans:3},{q:'¿Cómo se dice "El paraguas" en francés?',opts:['Le parapluie','Le verre','L\'horloge','La montre'],ans:0},{q:'¿Cómo se dice "El espejo" en francés?',opts:['Le miroir','La tasse','Le portable','Les lunettes'],ans:0},{q:'¿Cómo se dice "La toalla" en francés?',opts:['L\'ordinateur','Le téléphone','La serviette','Le parapluie'],ans:2}]},
{id:'log',level:1,emoji:'🏠',name:'Le Logement',sub:'Salon, cuisine… / La vivienda',words:[{es:'La casa',fr:'La maison',em:'🏠'},{es:'El piso / El apartamento',fr:'L\'appartement',em:'🏢'},{es:'La entrada / El recibidor',fr:'L\'entrée',em:'🚪'},{es:'El salón / El comedor',fr:'Le salon / la salle à manger',em:'🛋️'},{es:'La cocina',fr:'La cuisine',em:'🍳'},{es:'La habitación / El dormitorio',fr:'La chambre',em:'🛏️'},{es:'El cuarto de baño',fr:'La salle de bain',em:'🚿'},{es:'El aseo / Los servicios',fr:'Les toilettes',em:'🚽'},{es:'El garaje',fr:'Le garage',em:'🚗'}],quiz10:[{q:'¿Cómo se dice "El cuarto de baño" en francés?',opts:['La salle de bain','Les toilettes','Le garage','La chambre'],ans:0},{q:'¿Cómo se dice "La entrada" en francés?',opts:['L\'entrée','La cuisine','La maison','La chambre'],ans:0},{q:'¿Cómo se dice "La casa" en francés?',opts:['Le garage','La maison','La cuisine','Les toilettes'],ans:1},{q:'¿Cómo se dice "El piso" en francés?',opts:['L\'appartement','Le garage','La maison','Les toilettes'],ans:0},{q:'¿Cómo se dice "El garaje" en francés?',opts:['La cuisine','L\'entrée','Le garage','Les toilettes'],ans:2}]},
{id:'muebles_equipamiento',level:1,emoji:'🪑',name:'Meubles et équipements',sub:'Canapé, électroménager, salle de bain… / Muebles y equipamiento',words:[{es:'El sofá',fr:'Le canapé',em:'🛋️'},{es:'El sillón',fr:'Le fauteuil',em:'💺'},{es:'La mesa',fr:'La table',em:'🪵'},{es:'La silla',fr:'La chaise',em:'🪑'},{es:'La lámpara',fr:'La lampe',em:'💡'},{es:'La estantería',fr:'L\'étagère',em:'📚'},{es:'La cama',fr:'Le lit',em:'🛏️'},{es:'El armario',fr:'L\'armoire',em:'🗄️'},{es:'El escritorio',fr:'Le bureau',em:'🖊️'},{es:'La nevera / El frigorífico',fr:'Le réfrigérateur',em:'🧊'},{es:'El horno',fr:'Le four',em:'🔥'},{es:'El microondas',fr:'Le micro-ondes',em:'🔲♨️'},{es:'El fregadero',fr:'L\'évier',em:'🚰'},{es:'El lavabo',fr:'Le lavabo',em:'🚰'},{es:'La bañera',fr:'La baignoire',em:'🛁'},{es:'La ducha',fr:'La douche',em:'🚿'}],quiz10:[{q:'¿Cómo se dice "La mesa" en francés?',opts:['La douche','Le fauteuil','La table','Le lavabo'],ans:2},{q:'¿Cómo se dice "El armario" en francés?',opts:['La lampe','Le bureau','L\'évier','L\'armoire'],ans:3},{q:'¿Cómo se dice "El escritorio" en francés?',opts:['Le micro-ondes','La baignoire','Le bureau','Le canapé'],ans:2},{q:'¿Cómo se dice "La estantería" en francés?',opts:['Le four','L\'évier','L\'étagère','La baignoire'],ans:2},{q:'¿Cómo se dice "El fregadero" en francés?',opts:['Le bureau','L\'évier','Le canapé','La douche'],ans:1},{q:'¿Cómo se dice "El sillón" en francés?',opts:['L\'armoire','La table','Le micro-ondes','Le fauteuil'],ans:3},{q:'¿Cómo se dice "La bañera" en francés?',opts:['Le bureau','Le lit','L\'évier','La baignoire'],ans:3},{q:'¿Cómo se dice "El lavabo" en francés?',opts:['Le lavabo','L\'évier','Le bureau','Le four'],ans:0}]},
{id:'emot',level:1,emoji:'😄',name:'Les Émotions',sub:'Content, fatigué… / Las emociones',words:[{es:'Contento / Contenta',fr:'Content / Contente',em:'😊'},{es:'Feliz',fr:'Heureux / Heureuse',em:'😊'},{es:'Alegre',fr:'Joyeux / Joyeuse',em:'😄'},{es:'Triste',fr:'Triste / Triste',em:'😢'},{es:'Cansado / Cansada',fr:'Fatigué / Fatiguée',em:'😴'},{es:'Enfadado / Enfadada',fr:'Fâché / Fâchée',em:'😠'},{es:'Cabreado / Cabreada',fr:'Énervé / Énervée (coloquial España)',em:'😠'},{es:'Tener miedo',fr:'Avoir peur / Avoir peur',em:'😨'},{es:'Enfermo / Enferma',fr:'Malade / Malade',em:'🤒'},{es:'Pachucho / Pachucha',fr:'Pas très bien / Malade (coloquial afectuoso)',em:'🤒'},{es:'Preocupado / Preocupada',fr:'Inquiet / Inquiète',em:'😟'},{es:'Estresado / Estresada',fr:'Stressé / Stressée',em:'😰'},{es:'Agobiado / Agobiada',fr:'Stressé / Stressée',em:'😰'},{es:'Decepcionado / Decepcionada',fr:'Déçu / Déçue',em:'😞'},{es:'Enamorado / Enamorada',fr:'Amoureux / Amoureuse',em:'😍'},{es:'¡Qué guay! / ¡Mola!',fr:'C\'est super ! / C\'est cool ! (coloquial España)',em:'🌟'}],quiz10:[{q:'¿Cómo se dice "Enamorado" en francés?',opts:['Amoureux','Fâché','Triste','Pas très bien'],ans:0},{q:'¿Cómo se dice "Pachucho" en francés?',opts:['Avoir peur','C\'est super !','Fatigué','Pas très bien'],ans:3},{q:'¿Cómo se dice "¡Qué guay!" en francés?',opts:['Triste','Stressé','C\'est super !','Content'],ans:2},{q:'¿Cómo se dice "Cabreado" en francés?',opts:['Énervé','C\'est super !','Déçu','Stressé'],ans:0},{q:'¿Cómo se dice "Cansado" en francés?',opts:['Énervé','Malade','Fatigué','Inquiet'],ans:2},{q:'¿Cómo se dice "Alegre" en francés?',opts:['Joyeux','Malade','Amoureux','Fatigué'],ans:0},{q:'¿Cómo se dice "Estresado" en francés?',opts:['C\'est super !','Joyeux','Heureux','Stressé'],ans:3},{q:'¿Cómo se dice "Feliz" en francés?',opts:['Amoureux','Heureux','Pas très bien','Énervé'],ans:1}]},
{id:'fam',level:1,emoji:'👨‍👩‍👧',name:'La Famille',sub:'Papa, maman, fils… / La familia',words:[{es:'La madre / La mamá',fr:'La mère / La maman',em:'👩'},{es:'El padre / El papá',fr:'Le père / Le papa',em:'👨'},{es:'La hija',fr:'La fille',em:'👧'},{es:'El hijo',fr:'Le fils',em:'👦'},{es:'La hermana',fr:'La sœur',em:'👧'},{es:'El hermano',fr:'Le frère',em:'🧑'},{es:'La abuela',fr:'La grand-mère',em:'👵'},{es:'El abuelo',fr:'Le grand-père',em:'👴'},{es:'La mujer / La esposa',fr:'La femme',em:'💑'},{es:'El marido / El esposo',fr:'Le mari',em:'💍'},{es:'El tío / La tía',fr:'L\'oncle / La tante',em:'👨/👩'}],quiz10:[{q:'¿Cómo se dice "La abuela" en francés?',opts:['L\'oncle','Le fils','La fille','La grand-mère'],ans:3},{q:'¿Cómo se dice "El marido" en francés?',opts:['La grand-mère','Le frère','L\'oncle','Le mari'],ans:3},{q:'¿Cómo se dice "La hija" en francés?',opts:['Le grand-père','Le fils','La fille','La femme'],ans:2},{q:'¿Cómo se dice "La madre" en francés?',opts:['Le mari','La mère','Le frère','Le père'],ans:1},{q:'¿Cómo se dice "El hermano" en francés?',opts:['Le père','Le grand-père','Le frère','La sœur'],ans:2},{q:'¿Cómo se dice "La hermana" en francés?',opts:['Le grand-père','La grand-mère','La sœur','La femme'],ans:2},{q:'¿Cómo se dice "El padre" en francés?',opts:['La mère','Le père','La sœur','La grand-mère'],ans:1},{q:'¿Cómo se dice "El tío" en francés?',opts:['Le mari','Le fils','L\'oncle','Le frère'],ans:2}]},
{id:'verb',level:1,emoji:'📝',name:'Les Verbes',sub:'Être, avoir, aller… / Los verbos',words:[{es:'Ser / Estar',fr:'Être (ser=permanente : soy español / estar=temporal : estoy cansado)',em:'🧑',conj:{es:['Yo soy/estoy','Tú eres/estás','Él/Ella es/está','Nosotros somos/estamos','Vosotros sois/estáis','Ellos/Ellas son/están'],fr:['Je suis','Tu es','Il/Elle est','Nous sommes','Vous êtes','Ils/Elles sont']}},{es:'Tener',fr:'Avoir',em:'🤲',conj:{es:['Yo tengo','Tú tienes','Él/Ella tiene','Nosotros tenemos','Vosotros tenéis','Ellos/Ellas tienen'],fr:['J\'ai','Tu as','Il/Elle a','Nous avons','Vous avez','Ils/Elles ont']}},{es:'Hablar',fr:'Parler',em:'🗣️',conj:{es:['Yo hablo','Tú hablas','Él/Ella habla','Nosotros hablamos','Vosotros habláis','Ellos/Ellas hablan'],fr:['Je parle','Tu parles','Il/Elle parle','Nous parlons','Vous parlez','Ils/Elles parlent']}},{es:'Vivir',fr:'Habiter',em:'🏠',conj:{es:['Yo vivo','Tú vives','Él/Ella vive','Nosotros vivimos','Vosotros vivís','Ellos/Ellas viven'],fr:['J\'habite','Tu habites','Il/Ella habite','Nous habitons','Vous habitez','Ils/Elles habitent']}}],quiz10:[{q:'¿Cómo se dice "Sourire" en francés?',opts:['Sourire','Se doucher','Travailler','Conduire'],ans:0},{q:'¿Cómo se dice "Conducir" en francés?',opts:['Dormir','Conduire','Manger','Trop bien !'],ans:1},{q:'¿Cómo se dice "Tener" en franchisé?',opts:['Avoir','Aimer','Aller','Partir'],ans:0},{q:'¿Cómo se dice "Pagar" en francés?',opts:['Acheter','Appeler','Vendre','Payer'],ans:3},{q:'¿Cómo se dice "Dormir" en francés?',opts:['Conduire','Dormir','Boire','Vendre'],ans:1},{q:'¿Cómo se dice "Buscar" en francés?',opts:['Manger','Partir','Habiter','Chercher'],ans:3},{q:'¿Cómo se dice "Aprender" en francés?',opts:['Apprendre','Acheter','Courir','Travailler'],ans:0},{q:'¿Cómo se dice "Escuchar" en francés?',opts:['Écouter','Parler','Cuisiner','Appeler'],ans:0},{q:'¿Cómo se dice "Trabajar" en francés?',opts:['Marcher','Travailler','Habiter','Dormir'],ans:1},{q:'¿Cómo se dice "Llegar" en francés?',opts:['Aller','Arriver','Travailler','Sourire'],ans:1},{q:'¿Cómo se dice "Comprar" en francés?',opts:['Regarder','Appeler','Prendre','Acheter'],ans:3},{q:'¿Cómo se dice "Vivir" en francés?',opts:['Manger','Partir','Habiter','Arriver'],ans:2}]},
{id:'corps',level:1,emoji:'🧍',name:'Le Corps',sub:'Tête, bras, pied… / El cuerpo',words:[{es:'La cabeza',fr:'La tête',em:'🗣️'},{es:'El pelo',fr:'Les cheveux',em:'💇‍♂️'},{es:'El ojo / Los ojos',fr:'L\'œil / Les yeux',em:'👀'},{es:'La nariz',fr:'Le nez',em:'👃'},{es:'La oreja / Las orejas',fr:'L\'oreille / Les oreilles',em:'👂'},{es:'La boca',fr:'La bouche',em:'👄'},{es:'Los labios',fr:'Les lèvres',em:'💋'},{es:'La lengua',fr:'La langue',em:'👅'},{es:'El diente / Los dientes',fr:'La dent / Les dents',em:'🦷'},{es:'El cuello',fr:'Le cou',em:'🦒'},{es:'El brazo / Los brazos',fr:'Le bras / Les bras',em:'💪'},{es:'La mano / Las manos',fr:'La main / Les mains',em:'✋'},{es:'El dedo / Los dedos',fr:'Le doigt / Les doigts',em:'☝️'},{es:'La uña / Las uñas',fr:'L\'ongle / Les ongles',em:'💅'},{es:'La espalda',fr:'Le dos',em:'🧍'},{es:'La barriga / La tripa',fr:'Le ventre',em:'🫃'},{es:'La pierna / Las piernas',fr:'La jambe / Les jambes',em:'🦵'},{es:'El pie / Los pies',fr:'Le pied / Les pieds',em:'🦶'},{es:'El corazón',fr:'Le cœur',em:'❤️'},{es:'El cerebro',fr:'Le cerveau',em:'🧠'},{es:'El hueso / Los huesos',fr:'L\'os / Les os',em:'🦴'}],quiz10:[{q:'¿Cómo se dice "El cerebro" en francés?',opts:['La langue','Le cerveau','Le pied','La tête'],ans:1},{q:'¿Cómo se dice "La uña" en francés?',opts:['L\'oreille','L\'ongle','Le cou','Les cheveux'],ans:1},{q:'¿Cómo se dice "El ojo" en francés?',opts:['La tête','L\'œil','Le nez','La jambe'],ans:1},{q:'¿Cómo se dice "El hueso" en francés?',opts:['Les cheveux','Le pied','L\'os','L\'ongle'],ans:2},{q:'¿Cómo se dice "La nariz" en francés?',opts:['La tête','Le bras','L\'ongle','Le nez'],ans:3},{q:'¿Cómo se dice "Los labios" en francés?',opts:['L\'oreille','La main','Le cœur','Les lèvres'],ans:3},{q:'¿Cómo se dice "La oreja" en francés?',opts:['Le bras','La bouche','L\'oreille','Les lèvres'],ans:2},{q:'¿Cómo se dice "La boca" en francés?',opts:['La bouche','Les lèvres','L\'œil','La langue'],ans:0},{q:'¿Cómo se dice "El diente" en francés?',opts:['Le bras','La langue','Les lèvres','La dent'],ans:3},{q:'¿Cómo se dice "La mano" en francés?',opts:['La langue','Le cerveau','L\'œil','La main'],ans:3},{q:'¿Cómo se dice "La barriga" en francés?',opts:['Le dos','Le cou','La jambe','Le ventre'],ans:3},{q:'¿Cómo se dice "La pierna" en francés?',opts:['La bouche','Le cou','La jambe','La langue'],ans:2}]},
{id:'sante',level:1,emoji:'🏥',name:'La Santé',sub:'Médecin, pharmacie… / La salud',words:[{es:'Doler / Me duele',fr:'Faire mal / j\'ai mal (me duele la cabeza = j\'ai mal à la tête)',em:'🤕'},{es:'Tener dolor',fr:'Avoir une douleur (plus formel)',em:'😣'},{es:'La fiebre',fr:'La fièvre',em:'🌡️'},{es:'La tos',fr:'La toux',em:'😮‍💨'},{es:'El pañuelo de papel / El pañuelo',fr:'Le mouchoir',em:'🤧'},{es:'El termómetro',fr:'Le thermomètre',em:'🌡️'},{es:'La cita',fr:'Le rendez-vous',em:'📅'},{es:'El médico / La médica / El doctor',fr:'Le médecin / Le docteur',em:'🩺'},{es:'El/la paciente',fr:'Le/la patient(e)',em:'🛏️'},{es:'La consulta médica',fr:'La consultation médicale',em:'📋'},{es:'El enfermero / La enfermera',fr:'L\'infirmier / L\'infirmière',em:'👨‍⚕️'},{es:'El hospital',fr:'L\'hôpital',em:'🏥'},{es:'La receta',fr:'L\'ordonnance',em:'📋'},{es:'La farmacia',fr:'La pharmacie',em:'🏪'},{es:'El medicamento / La medicina',fr:'Le médicament',em:'💊'},{es:'La pastilla / El comprimido',fr:'Le comprimé',em:'💊'},{es:'La vacuna',fr:'Le vaccin',em:'💉'},{es:'La tirita',fr:'Le pansement adhésif',em:'🩹'},{es:'El vendaje / La venda',fr:'Le bandage',em:'🩼'},{es:'La ambulancia',fr:'L\'ambulance',em:'🚑'},{es:'Las urgencias',fr:'Les urgences',em:'🆘'}],quiz10:[{q:'¿Cómo se dice "El medicamento" en francés?',opts:['Faire mal','L\'ordonnance','L\'hôpital','Le médicament'],ans:3},{q:'¿Cómo se dice "La receta" en francés?',opts:['L\'ordonnance','L\'ambulance','Le comprimé','Avoir une douleur'],ans:0},{q:'¿Cómo se dice "La vacuna" en francés?',opts:['Le thermomètre','Le vaccin','L\'ordonnance','L\'ambulance'],ans:1},{q:'¿Cómo se dice "El enfermero" en francés?',opts:['Le/la patient','Le pansement adhésif','Le bandage','L\'infirmier'],ans:3},{q:'¿Cómo se dice "La fiebre" en francés?',opts:['La fièvre','Le mouchoir','Le thermomètre','Le médicament'],ans:0},{q:'¿Cómo se dice "El vendaje" en francés?',opts:['Le bandage','Le thermomètre','Faire mal','Le rendez-vous'],ans:0},{q:'¿Cómo se dice "Las urgencias" en francés?',opts:['Le thermomètre','La fièvre','Les urgences','Le comprimé'],ans:2},{q:'¿Cómo se dice "La pastilla" en francés?',opts:['La fièvre','Le comprimé','Le rendez-vous','Le médecin'],ans:1},{q:'¿Cómo se dice "Doler" en francés?',opts:['La consultation médicale','Faire mal','La fièvre','Le pansement adhésif'],ans:1},{q:'¿Cómo se dice "El hospital" en francés?',opts:['L\'hôpital','La toux','La consultation médicale','La fièvre'],ans:0},{q:'¿Cómo se dice "La tos" en francés?',opts:['L\'infirmier','La toux','L\'hôpital','Avoir une douleur'],ans:1},{q:'¿Cómo se dice "La farmacia" en francés?',opts:['La pharmacie','Le mouchoir','Le/la patient','Le pansement adhésif'],ans:0}]},
{id:'ocio',level:1,emoji:'⛰️',name:'Les Loisirs',sub:'Sport, randonnée, lecture… / El ocio',words:[{es:'La lectura',fr:'La lecture',em:'📚'},{es:'El libro',fr:'Le livre',em:'📖'},{es:'La música',fr:'La musique',em:'🎵'},{es:'El cine',fr:'Le cinéma',em:'🎬'},{es:'El teatro',fr:'Le théâtre',em:'🎭'},{es:'El deporte',fr:'Le sport',em:'⚽'},{es:'La natación',fr:'La natation',em:'🏊'},{es:'El ciclismo',fr:'Le cyclisme',em:'🚴'},{es:'El atletismo',fr:'L\'athlétisme',em:'🏃'},{es:'El senderismo',fr:'La randonnée',em:'🥾'},{es:'La caminata / La marcha',fr:'La marche / La promenade',em:'🚶'},{es:'El paseo',fr:'La balade',em:'🌳'},{es:'Jugar',fr:'Jouer',em:'🎮'},{es:'Practicar',fr:'Pratiquer',em:'💪'},{es:'Descansar',fr:'Se reposer',em:'😴'},{es:'Disfrutar',fr:'Profiter / Apprécier',em:'😊'}],quiz10:[{q:'¿Cómo se dice "El deporte" en francés?',opts:['La balade','La musique','Le sport','La natation'],ans:2},{q:'¿Cómo se dice "El cine" en francés?',opts:['L\'athlétisme','La lecture','Le cinéma','Profiter'],ans:2},{q:'¿Cómo se dice "Disfrutar" en francés?',opts:['Jouer','La marche','L\'athlétisme','Profiter'],ans:3},{q:'¿Cómo se dice "El senderismo" en francés?',opts:['Le football','Profiter','Se reposer','La randonnée'],ans:3},{q:'¿Cómo se dice "El ciclismo" en francés?',opts:['Le sport','La lecture','La musique','Le cyclisme'],ans:3},{q:'¿Cómo se dice "La música" en francés?',opts:['La marche','La balade','Pratiquer','La musique'],ans:3},{q:'¿Cómo se dice "Practicar" en francés?',opts:['Pratiquer','Profiter','Se reposer','La marche'],ans:0},{q:'¿Cómo se dice "Jugar" en francés?',opts:['La balade','Jouer','La natation','Le football'],ans:1}]},
{id:'veth',level:1,emoji:'👗',name:'Les Vêtements',sub:'T-shirt, pantalon… / La ropa',words:[{es:'La camiseta',fr:'Le t-shirt',em:'👕'},{es:'La camisa',fr:'La chemise',em:'👔'},{es:'El pantalón',fr:'Le pantalon',em:'👖'},{es:'Los zapatos / Las zapatillas',fr:'Les chaussures / Les baskets',em:'👟'},{es:'Los calcetines',fr:'Les chaussettes',em:'🧦'},{es:'El vestido / La falda',fr:'La robe / La jupe',em:'👗'},{es:'Los pantalones cortos / El short',fr:'Le short',em:'🩳'},{es:'El jersey',fr:'Le pull',em:'🧥'},{es:'La chaqueta',fr:'La veste',em:'🧥'},{es:'El sombrero / La gorra',fr:'Le chapeau / La casquette',em:'🎩'},{es:'El abrigo',fr:'Le manteau',em:'🧥'},{es:'La bufanda',fr:'L\'écharpe',em:'🧣'},{es:'Los guantes',fr:'Les gants',em:'🧤'},{es:'El gorro',fr:'Le bonnet',em:'A0'},{es:'El bolso',fr:'Le sac',em:'👜'},{es:'El traje de baño / El bañador',fr:'Le maillot de bain',em:'🩱'}],quiz10:[{q:'¿Cómo se dice "La bufanda" en francés?',opts:['Le bonnet','Le maillot de bain','La chemise','L\'écharpe'],ans:3},{q:'¿Cómo se dice "El gorro" en francés?',opts:['Les chaussures','Le bonnet','Le short','L\'écharpe'],ans:1},{q:'¿Cómo se dice "La chaqueta" en francés?',opts:['Les chaussures','La veste','Le pantalon','Le pull'],ans:1},{q:'¿Cómo se dice "La camiseta" en francés?',opts:['La chemise','Les chaussettes','Le maillot de bain','Le t-shirt'],ans:3},{q:'¿Cómo se dice "El pantalón" en francés?',opts:['Le pantalon','La veste','Le t-shirt','Le chapeau'],ans:0},{q:'¿Cómo se dice "Los zapatos" en francés?',opts:['Le bonnet','La chemise','Les chaussures','Le chapeau'],ans:2},{q:'¿Cómo se dice "El jersey" en francés?',opts:['Le sac','Le pull','Le pantalon','Le chapeau'],ans:1},{q:'¿Cómo se dice "El sombrero" en francés?',opts:['Les chaussures','Le chapeau','La chemise','Le sac'],ans:1}]},
{id:'pays',level:1,emoji:'🌍',name:'Les Pays',sub:'France, Équateur… / Los países',words:[{es:'Francia',fr:'La France',em:'🇫🇷'},{es:'Ecuador',fr:'L\'Équateur',em:'🇪🇨'},{es:'España',fr:'L\'Espagne',em:'🇪🇸'},{es:'Portugal',fr:'Le Portugal',em:'🇵🇹'},{es:'Italia',fr:'L\'Italie',em:'🇮🇹'},{es:'Bélgica',fr:'La Belgique',em:'🇧🇪'},{es:'Suiza',fr:'La Suisse',em:'🇨🇭'},{es:'Alemania',fr:'L\'Allemagne',em:'🇩🇪'},{es:'Reino Unido',fr:'Le Royaume-Uni',em:'🇬🇧'},{es:'México',fr:'Le Mexique',em:'🇲🇽'},{es:'Colombia',fr:'La Colombie',em:'🇨🇴'},{es:'Perú',fr:'Le Pérou',em:'🇵🇪'},{es:'Argentina',fr:'L\'Argentine',em:'🇦🇷'},{es:'Brasil',fr:'Le Brésil',em:'🇧🇷'},{es:'Canadá',fr:'Le Canada',em:'🇨🇦'},{es:'Marruecos',fr:'Le Maroc',em:'🇲🇦'},{es:'Estados Unidos',fr:'Les États-Unis',em:'🇺🇸'},{es:'Rusia',fr:'La Russie',em:'🇷🇺'},{es:'China',fr:'La Chine',em:'🇨🇳'},{es:'Japón',fr:'Le Japon',em:'🇯🇵'},{es:'India',fr:'L\'Inde',em:'🇮🇳'},{es:'Turquía',fr:'La Turquie',em:'🇹🇷'},{es:'Grecia',fr:'La Grèce',em:'🇬🇷'},{es:'Australia',fr:'L\'Australie',em:'🇦🇺'},{es:'Sudáfrica',fr:'L\'Afrique du Sud',em:'🇿🇦'}],quiz10:[{q:'¿Cómo se dice "Bélgica" en francés?',opts:['L\'Allemagne','La Grèce','La Chine','La Belgique'],ans:3},{q:'¿Cómo se dice "Japón" en francés?',opts:['Le Royaume-Uni','Les États-Unis','Le Japon','L\'Équateur'],ans:2},{q:'¿Cómo se dice "Ecuador" en francés?',opts:['La Russie','Le Canada','L\'Équateur','Le Maroc'],ans:2},{q:'¿Cómo se dice "Canadá" en francés?',opts:['Le Canada','Le Mexique','L\'Australie','L\'Équateur'],ans:0},{q:'¿Cómo se dice "Perú" en francés?',opts:['Le Canada','La Russie','Le Pérou','L\'Argentine'],ans:2},{q:'¿Cómo se dice "Italia" en francés?',opts:['L\'Espagne','L\'Italie','Le Mexique','L\'Inde'],ans:1},{q:'¿Cómo se dice "Australia" en francés?',opts:['La Belgique','La Turquie','L\'Australie','L\'Italie'],ans:2},{q:'¿Cómo se dice "Turquía" en francés?',opts:['L\'Allemagne','La Turquie','La Grèce','L\'Espagne'],ans:1},{q:'¿Cómo se dice "España" en francés?',opts:['Le Brésil','Le Japon','L\'Espagne','Le Royaume-Uni'],ans:2},{q:'¿Cómo se dice "Portugal" en francés?',opts:['Le Brésil','L\'Espagne','Le Portugal','La Suisse'],ans:2},{q:'¿Cómo se dice "Francia" en francés?',opts:['La France','Le Royaume-Uni','La Russie','La Turquie'],ans:0},{q:'¿Cómo se dice "Reino Unido" en francés?',opts:['La Colombie','Le Royaume-Uni','Les États-Unis','L\'Italie'],ans:1}]},
{id:'met',level:1,emoji:'💼',name:'Les Professions',sub:'Médecin, prof… / Las profesiones',words:[{es:'El/la estudiante',fr:'L\'étudiant / L\'étudiante',em:'🎓'},{es:'El profesor / La profesora',fr:'Le professeur / La professeure',em:'👩‍🏫'},{es:'El camarero / La camarera',fr:'Le serveur / La serveuse',em:'🍽️'},{es:'El vendedor / La vendedora',fr:'Le vendeur / La vendeuse',em:'🏪'},{es:'El/la taxista',fr:'Le chauffeur de taxi / La chauffeuse de taxi',em:'🚕'},{es:'El médico / La médica / El doctor',fr:'Le médecin / Le docteur',em:'🩺'},{es:'El enfermero / La enfermera',fr:'L\'infirmier / L\'infirmière',em:'👨‍⚕️'},{es:'El cocinero / La cocinera',fr:'Le cuisinier / La cuisinière',em:'👨‍🍳'},{es:'El fontanero / La fontanera',fr:'Le plombier / La plombière',em:'🔧'},{es:'El informático / La informática',fr:'L\'informaticien / Le technicien système',em:'💻'}],quiz10:[{q:'¿Cómo se dice "El fontanero" en francés?',opts:['Le professeur','Le plombier','Le chauffeur de taxi','Le médecin'],ans:1},{q:'¿Cómo se dice "El médico" en francés?',opts:['L\'étudiant','Le médecin','Le plombier','L\'infirmier'],ans:1},{q:'¿Cómo se dice "El informático" en francés?',opts:['Le professeur','L\'informaticien','Le vendeur','Le cuisinier'],ans:1},{q:'¿Cómo se dice "El profesor" en francés?',opts:['Le chauffeur de taxi','Le médecin','L\'infirmier','Le professeur'],ans:3},{q:'¿Cómo se dice "El enfermero" en francés?',opts:['Le cuisinier','Le chauffeur de taxi','Le professeur','L\'infirmier'],ans:3},{q:'¿Cómo se dice "El/la estudiante" en francés?',opts:['L\'informaticien','Le médecin','L\'étudiant','Le cuisinier'],ans:2},{q:'¿Cómo se dice "El/la taxista" en francés?',opts:['L\'infirmier','Le chauffeur de taxi','Le serveur','Le vendeur'],ans:1},{q:'¿Cómo se dice "El vendedor" en francés?',opts:['Le vendeur','Le médecin','Le professeur','L\'infirmier'],ans:0}]},
{id:'anim',level:1,emoji:'🐘',name:'Les Animaux',sub:'Chien, chat, perroquet… / Los animales',words:[{es:'El perro',fr:'Le chien',em:'🐶'},{es:'El gato',fr:'Le chat',em:'🐱'},{es:'El pájaro / El loro',fr:'L\'oiseau / Le perroquet',em:'🐦'},{es:'El pez',fr:'Le poisson (vivant)',em:'🐟'},{es:'El caballo',fr:'Le cheval',em:'🐴'},{es:'La vaca',fr:'La vache',em:'🐮'},{es:'El cerdo / El guarro',fr:'Le cochon',em:'🐷'},{es:'La gallina',fr:'La poule',em:'🐔'},{es:'El conejo',fr:'Le lapin',em:'🐰'},{es:'El pescado',fr:'Le poisson (dans l\'assiette)',em:'🐟🍽️'},{es:'El toro',fr:'Le taureau',em:'🐂'},{es:'El pato',fr:'Le canard',em:'🦆'},{es:'El gallo',fr:'Le coq',em:'🐓'},{es:'El cordero',fr:'L\'agneau',em:'🐑'},{es:'La cabra',fr:'La chèvre',em:'🐐'},{es:'El burro',fr:'L\'âne',em:'🫏'},{es:'El elefante',fr:'L\'éléphant',em:'🐘'},{es:'El oso',fr:'L\'ours',em:'🐻'},{es:'El tigre',fr:'Le tigre',em:'🐯'},{es:'El delfín',fr:'Le dauphin',em:'🐬'},{es:'La ballena',fr:'La baleine',em:'🐳'},{es:'El cóndor',fr:'Le condor',em:'🦅'},{es:'La mariposa',fr:'Le papillon',em:'🦋'},{es:'La rana',fr:'La grenouille',em:'🐸'},{es:'La serpiente',fr:'Le serpent',em:'🐍'},{es:'El lagarto / La lagartija',fr:'Le lézard',em:'🦎'},{es:'La araña',fr:'L\'araignée',em:'🕷️'},{es:'El mosquito',fr:'Le moustique',em:'🦟'},{es:'La hormiga',fr:'La fourmi',em:'🐜'}],quiz10:[{q:'¿Cómo se dice "La gallina" en francés?',opts:['L\'oiseau','Le coq','La poule','Le cheval'],ans:2},{q:'¿Cómo se dice "El cordero" en francés?',opts:['Le condor','L\'agneau','La chèvre','La vaca'],ans:1},{q:'¿Cómo se dice "El elefante" en francés?',opts:['Le tigre','L\'éléphant','Le papillon','Le dauphin'],ans:1},{q:'¿Cómo se dice "La hormiga" en francés?',opts:['Le cochon','La vache','La fourmi','Le serpent'],ans:2},{q:'¿Cómo se dice "La cabra" en francés?',opts:['Le cheval','Le condor','La chèvre','L\'âne'],ans:2},{q:'¿Cómo se dice "El burro" en francés?',opts:['L\'âne','Le lézard','Le poisson','Le papillon'],ans:0},{q:'¿Cómo se dice "El gallo" en francés?',opts:['Le condor','Le coq','La chèvre','La grenouille'],ans:1},{q:'¿Cómo se dice "El mosquito" en francés?',opts:['Le coq','Le moustique','Le cochon','Le chat'],ans:1},{q:'¿Cómo se dice "El cerdo" en francés?',opts:['La grenouille','Le cheval','Le canard','Le cochon'],ans:3},{q:'¿Cómo se dice "La ballena" en francés?',opts:['La chèvre','Le tigre','La baleine','La vache'],ans:2},{q:'¿Cómo se dice "El pájaro" en francés?',opts:['Le poisson','L\'oiseau','L\'araignée','Le condor'],ans:1},{q:'¿Cómo se dice "El pez" en francés?',opts:['L\'éléphant','Le poisson','La poule','L\'âne'],ans:1}]},
{id:'plan',level:1,emoji:'🌿',name:'Les Plantes',sub:'Fleur, arbre, forêt… / Las plantas',words:[{es:'La flor',fr:'La fleur',em:'🌸'},{es:'El árbol',fr:'L\'arbre',em:'🌳'},{es:'La hoja',fr:'La feuille',em:'🍃'},{es:'La hierba / El césped',fr:'L\'herbe',em:'🌱'},{es:'El jardín',fr:'Le jardin',em:'🏡'},{es:'La rosa',fr:'La rose',em:'🌹'},{es:'El bosque',fr:'La forêt / La jungle',em:'🌲'},{es:'El césped',fr:'La pelouse / Le gazon',em:'⛳'}],quiz10:[{q:'¿Cómo se dice "El árbol" en francés?',opts:['L\'arbre','La rose','La forêt','Le jardin'],ans:0},{q:'¿Cómo se dice "El césped" en francés?',opts:['La rose','La pelouse','La fleur','La forêt'],ans:1},{q:'¿Cómo se dice "La flor" en francés?',opts:['La rose','La pelouse','La forêt','La fleur'],ans:3},{q:'¿Cómo se dice "El jardín" en francés?',opts:['Le jardin','La fleur','La pelouse','La feuille'],ans:0},{q:'¿Cómo se dice "La hoja" en francés?',opts:['La feuille','L\'herbe','La forêt','La pelouse'],ans:0}]}
];
