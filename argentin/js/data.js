/* ========================================
   Français → Español Argentin 🇦🇷 – Données
...
var LEVEL1_THEMES=[
  ...
  {id:'pres',level:1,emoji:'🙋',name:'Se Présenter',sub:'Nom, âge, pays… / Presentarse',
   ...
   quiz10:[
    ...
    {q:'¿Cómo se dice "Soy argentino" en francés?',opts:['Je suis français','Je suis argentin','J\'habite Argentine','Je parle argentino'],ans:1},
  ...
  {id:'col',level:1,emoji:'🎨',name:'Les Couleurs',sub:'Rouge, bleu, vert… / Los colores',
   words:[
    ...
    {fr:'Violet',es:'Morado / violeta',em:'💜'},{fr:'Marron',es:'Marrón / café',em:'🤎'},
    {fr:'Gris',es:'Gris',em:'🩶'}
   ],
   quiz10:[
    ...
    {q:'¿Qué significa "Noir"?',opts:['Blanco','Gris','Marrón','Negro'],ans:3},
    ...
    {q:'¿Cómo se dice "Marrón" en francés?',opts:['Gris','Marron','Noir','Rouge'],ans:1},
  ...
  {id:'nour',level:1,emoji:'🍽️',name:'La Nourriture',sub:'Pain, légumes, fruits… / La comida',
   words:[
    ...
    {fr:'La pomme',es:'La manzana',em:'🍎'},{fr:'La banane',es:'La banana',em:'🍌'},
    {fr:'La tomate',es:'El tomate',em:'🍅'},{fr:'La carotte',es:'La zanahoria',em:'🥕'},
    {fr:'L\'œuf',es:'El huevo',em:'🥚'},{fr:'Le beurre',es:'La mantequilla',em:'🧈'},
    {fr:'Les fruits',es:'Las frutas',em:'🍉'},{fr:'Les légumes',es:'Los vegetales / la verdura',em:'🥦'},
    {fr:'Le bonbon',es:'El caramelo / el dulce',em:'🍬'},{fr:'Le sel',es:'La sal',em:'🧂'},
    {fr:'Le poivre',es:'La pimienta',em:'🌶️'},{fr:'Les pâtes',es:'Los pastiches / la pasta',em:'🍝'},
    {fr:'La pomme de terre',es:'La papa',em:'🥔'},{fr:'Le maïs',es:'El maíz',em:'🌽'},
    ...
    {fr:'La fraise',es:'La frutilla',em:'🍓'},{fr:'La pastèque',es:'La sandía',em:'🍉'},
    {fr:'Les cacahuètes',es:'El maní',em:'🥜'},
    {fr:'Le chocolat',es:'El chocolate',em:'🍫'},{fr:'Le miel',es:'La miel',em:'🍯'},
    {fr:'La citrouille',es:'La calabaza',em:'🎃'},{fr:'Les haricots',es:'Los porotos',em:'🫘'}
   ],
   quiz10:[
    ...
    {q:'¿Qué significa "Les légumes"?',opts:['Las frutas','Los cereales','Los vegetales','Las bebidas'],ans:2},
    {q:'¿Cómo se dice "La manzana" en francés?',opts:['La banane','La fraise','La pomme','L\'orange'],ans:2},
    {q:'¿Cómo se llama "la banana" en francés?',opts:['La pomme','La fraise','La banane','L\'orange'],ans:2},
    {q:'¿Cómo se llama "la calabaza" en francés?',opts:['La carotte','La citrouille','Le maïs','L\'oignon'],ans:1},
    {q:'¿Cómo se llama "los porotos" en francés?',opts:['Les pâtes','Les cacahuètes','Les haricots','Le riz'],ans:2},
  ...
  {id:'bois',level:1,emoji:'🥤',name:'Les Boissons',sub:'Eau, café, jus… / Las bebidas',
   words:[
    ...
    {fr:'La bière',es:'La cerveza',em:'🍺'},{fr:'Le soda',es:'La gaseosa',em:'🥤'},
  ...
  {id:'emot',level:1,emoji:'😄',name:'Les Émotions',sub:'Joyeux, triste… / Las emociones',
   words:[
    ...
    {fr:'Fatigué(e)',es:'Cansado / cansada',em:'😴'},{fr:'Fâché(e)',es:'Enojado',em:'😠'},
    {fr:'Stressé(e)',es:'Estresado / agobiado',em:'😰'},{fr:'Malade',es:'Enfermo',em:'🤒'},
    {fr:'Content(e)',es:'Contento / feliz',em:'😊'},{fr:'Inquiet / Inquiète',es:'Preocupado / ansioso',em:'😟'},
  ...
  {id:'log',level:1,emoji:'🏠',name:'Le Logement',sub:'Salon, cuisine… / La vivienda',
   words:[
    ...
    {fr:'Le garage',es:'El garaje / la cochera',em:'🚗'},
  ...
  {id:'veth',level:1,emoji:'👗',name:'Les Vêtements',sub:'T-shirt, pantalon… / La ropa',
   words:[
    {fr:'Le t-shirt',es:'La franela / la camiseta',em:'👕'},{fr:'Le pantalon',es:'El pantalón',em:'👖'},
    {fr:'La robe',es:'El vestido',em:'👗'},{fr:'La veste',es:'La chaqueta / la americana',em:'🧥'},
    ...
    {fr:'La casquette',es:'La gorra',em:'🧢'},{fr:'Les chaussettes',es:'Las medias',em:'🧦'},
    {fr:'Les gants',es:'Los guantes',em:'🧤'},{fr:'Le short',es:'El pantalón corto / el short',em:'🩳'},
    {fr:'Le pull',es:'El suéter / la suéter',em:'🧥'},
    {fr:'Le maillot de bain',es:'El traje de baño / el vestido de baño',em:'🩱'},
    {fr:'La jupe',es:'La falda',em:'👗'},{fr:'La montre',es:'El reloj de pulsera',em:'⌚'},
    {fr:'Le slip',es:'El calzoncillo / la ropa interior',em:'🩲'},
    {fr:'Le bonnet',es:'El gorro de lana',em:'🎿'},
    {fr:'Le soutien-gorge',es:'El brasier / el sostén',em:'👙'},
    {fr:'Le boxer',es:'El bóxer',em:'🩳'},
    {fr:'La culotte',es:'La bombacha / la pantaleta',em:'🩲'}
   ],
   quiz10:[
    {q:'¿Cómo se dice "La franela" en francés?',opts:['Le pull','La chemise','Le t-shirt','La veste'],ans:2},
    ...
    {q:'¿Qué significa "Les chaussettes"?',opts:['Los zapatos','Los guantes','Las medias','El traje de baño'],ans:2}
   ]},
  {id:'corps',level:1,emoji:'🧍',name:'Le Corps',sub:'Tête, bras, pied… / El cuerpo',
   words:[
    ...
    {fr:'Le dos',es:'La espalda / el lomo',em:'🔙'},{fr:'Le ventre',es:'La barriga / el estómago',em:'🫃'},
  ...
  {id:'anim',level:1,emoji:'🐘',name:'Les Animaux',sub:'Chat, chien, cheval… / Los animales',
   words:[
    ...
    {fr:'L\'âne',es:'El burro',em:'🫏'},{fr:'Le cochon',es:'El cochino / el cerdo',em:'🐷'},
    ...
    {fr:'La grenouille',es:'La rana',em:'🐸'},{fr:'Le serpent',es:'La culebra / la serpiente',em:'🐍'},
    ...
    {fr:'Le moustique',es:'El mosquito',em:'🦟'},
    ...
    {fr:'La chèvre',es:'La cabra / el chivo',em:'🐐'},{fr:'L\'agneau',es:'El cordero',em:'🐑'}
   ],
   quiz10:[
    ...
    {q:'¿Qué significa "Le serpent"?',opts:['El lagarto','La rana','La culebra','El insecto'],ans:2},
    {q:'¿Cómo se dice "El mosquito" en francés?',opts:['La fourmi','Le papillon','L\'araignée','Le moustique'],ans:3},
    {q:'¿Qué significa "L\'agneau"?',opts:['La vaca','El cochino','El cordero','La cabra'],ans:2},
  ...
  {id:'verb',level:1,emoji:'📝',name:'Les Verbes Principaux',sub:'Être, avoir, aller… / Los verbos',
   words:[
    ...
    {fr:'Je me lave',es:'Me baño / me lavo (se laver)',em:'🧼'},{fr:'Je prends',es:'Tomo / agarro (prendre)',em:'🤲'},
  ...
  {id:'pays',level:1,emoji:'🌍',name:'Les Pays',sub:'France, Argentine… / Los países',
   words:[
    {fr:'La France',es:'Francia',em:'🇫🇷'},{fr:'L\'Argentine',es:'Argentina',em:'🇦🇷'},
    {fr:'L\'Espagne',es:'España',em:'🇪🇸'},{fr:'L\'Italie',es:'Italia',em:'🇮🇹'},
    {fr:'Le Canada',es:'Canadá',em:'🇨🇦'},{fr:'Le Brésil',es:'Brasil',em:'🇧🇷'},
    {fr:'La Colombie',es:'Colombia',em:'🇨🇴'},{fr:'Le Venezuela',es:'Venezuela',em:'🇻🇪'},
    {fr:'Le Mexique',es:'México',em:'🇲🇽'},{fr:'Le Chili',es:'Chile',em:'🇨🇱'},
    {fr:'Le Pérou',es:'Perú',em:'🇵🇪'},{fr:'L\'Équateur',es:'Ecuador',em:'🇪🇨'},
  ...
  {id:'plan',level:1,emoji:'🌿',name:'Les Plantes',sub:'Fleur, arbre, forêt… / Las plantas',
   words:[
    ...
    {fr:'Le jardin',es:'El jardín / la mata',em:'🏡'}
   ],
   quiz10:[
  ...
  {id:'salut',level:1,emoji:'👋',name:'Les Salutations',sub:'Bonjour, merci… / Los saludos',
   words:[
    ...
    {fr:'Salut',es:'Hola / ¡hola! (informal)',em:'👋'},{fr:'Au revoir',es:'Adiós / chau',em:'👋'},
    ...
    {fr:'Non',es:'No',em:'❌'},{fr:'Comment ça va ?',es:'¿Cómo estás? / ¿Cómo andás?',em:'🤗'},
    {fr:'Je vais bien, merci',es:'Estoy bien, gracias',em:'😊'},
    {fr:'Super !',es:'¡Qué copado! / ¡Genial!',em:'🌟'}
   ],
   quiz10:[
    ...
    {q:'¿Qué significa "Comment ça va ?"?',opts:['¿Dónde estás?','¿Cómo te llamas?','¿Cómo estás?','¿Cuántos años tenés?'],ans:2},
  ...
  {id:'met',level:1,emoji:'💼',name:'Les Professions',sub:'Médecin, cuisinier… / Las profesiones',
   words:[
    ...
    {fr:'Le vendeur',es:'El/la vendedor(a)',em:'🏪'},{fr:'Le serveur',es:'El/la mozo(a) / el mesero',em:'🍽️'},
  ...
  {id:'trans',level:1,emoji:'🚌',name:'Les Transports',sub:'Bus, train, vélo… / Los transportes',
   words:[
    {fr:'Le bus',es:'El colectivo / el autobús',em:'🚌'},{fr:'Le train',es:'El tren',em:'🚂'},
    {fr:'La voiture',es:'El auto / el coche',em:'🚗'},{fr:'Le vélo',es:'La bicicleta',em:'🚴'},
    {fr:'Le métro',es:'El subte / el metro',em:'🚇'},{fr:'Le taxi',es:'El taxi / el remis',em:'🚕'},
    {fr:'L\'avion',es:'El avión',em:'✈️'},{fr:'Le ticket',es:'El ticket / el boleto',em:'🎫'}
   ],
   quiz10:[
    {q:'¿Cómo se dice "El colectivo" en francés?',opts:['Le train','Le métro','Le bus','Le taxi'],ans:2},
    {q:'¿Qué significa "La voiture"?',opts:['El tren','La moto','El auto','El camión'],ans:2},
    {q:'¿Cómo se dice "El avión" en francés?',opts:['Le bateau','L\'avion','Le vélo','Le métro'],ans:1},
    {q:'¿Qué significa "Le vélo"?',opts:['El auto','La moto','El tren','La bicicleta'],ans:3},
    {q:'¿Cómo se dice "El subte" en francés?',opts:['Le bus','Le taxi','Le métro','Le train'],ans:2}
   ]},
  {id:'lieux',level:1,emoji:'🏙️',name:'Les Lieux Importants',sub:'Marché, hôpital… / Los lugares',
   words:[
    {fr:'Le supermarché',es:'El supermercado / el súper',em:'🛒'},{fr:'L\'école',es:'La escuela / el colegio',em:'🏫'},
    ...
    {fr:'L\'église',es:'La iglesia',em:'⛪'},{fr:'La mairie',es:'La municipalidad / la intendencia',em:'🏛️'},
    {fr:'Le champ',es:'El campo / la pampa',em:'🌾'},{fr:'La rivière',es:'El río / el arroyo',em:'🏞️'},
   ...
   quiz10:[
    ...
    {q:'¿Qué significa "La mairie"?',opts:['La iglesia','El tribunal','La municipalidad','El mercado'],ans:2},
    {q:'¿Cómo se dice "El río" en francés?',opts:['L\'océan','La montagne','Le champ','La rivière'],ans:3},
    {q:'¿Qué significa "Le supermarché"?',opts:['El mercado','El supermercado','La tienda','El almacén'],ans:1},
  ...
  {id:'sante',level:1,emoji:'🏥',name:'La Santé',sub:'Médecin, pharmacie… / La salud',
   ...
   quiz10:[
    ...
    {q:'¿Qué significa "Les urgences"?',opts:['El médico de guardia','La sala de espera','La guardia / urgencias','La consulta'],ans:2}
   ]},
  {id:'objets',level:1,emoji:'🔑',name:'Objets du Quotidien',sub:'Téléphone, clés… / Objetos del día',
   words:[
    ...
    {fr:'Les clés',es:'Las llaves',em:'🔑'},{fr:'Le portefeuille',es:'La billetera / el portafolios',em:'👛'},
    {fr:'Le sac à dos',es:'La mochila',em:'🎒'},
    {fr:'Les lunettes',es:'Los anteojos / los lentes',em:'👓'},
    {fr:'Le papier',es:'El papel',em:'📄'},{fr:'Le stylo',es:'El bolígrafo / la lapicera',em:'🖊️'},
   ...
   quiz10:[
    ...
    {q:'¿Qué significa "Les lunettes"?',opts:['Los audífonos','Los anteojos','Los guantes','Los relojes'],ans:1},
...
var LEVEL2_THEMES=[
  ...
  {id:'pres2',level:2,emoji:'🙋',name:'Se Présenter',sub:'En situation réelle / En situación real',type:'dialog',
   situations:[
    {label:'Sit. 1',title:'Encuentro amistoso',img:'🤝',
     dialogue:[
      {s:'Ana',fr:'Salut ! Je m\'appelle Ana. Et toi ?',tr:'¡Hola! Me llamo Ana. ¿Y vos?',side:'left'},
      {s:'Pedro',fr:'Moi c\'est Pedro. Je viens d\'Argentine.',tr:'Yo soy Pedro. Vengo de Argentina.',side:'right'},
      {s:'Ana',fr:'Ah super ! Tu habites à Lyon ?',tr:'¡Qué copado! ¿Vivís en Lyon?',side:'left'},
      {s:'Pedro',fr:'Oui, depuis six mois. J\'ai vingt-huit ans.',tr:'Sí, desde hace seis meses. Tengo veintiocho años.',side:'right'},
      {s:'Ana',fr:'Bienvenue ! Tu parles très bien français !',tr:'¡Bienvenido! ¡Hablás muy bien el francés!',side:'left'}
     ]},
    {label:'Sit. 2',title:'Ámbito profesional',img:'💼',
     dialogue:[
      ...
      {s:'Carlos',fr:'Je suis ingénieur. Je viens de Buenos Aires.',tr:'Soy ingeniero. Vengo de Buenos Aires.',side:'left'},
    ...
    {label:'Sit. 3',title:'Llegada a una escuela',img:'🏫',
     dialogue:[
      ...
      {s:'Luisa',fr:'Je suis argentine. J\'ai trente ans.',tr:'Soy argentina. Tengo treinta años.',side:'left'},
  ...
  {id:'num2',level:2,emoji:'🔢',name:'Les Nombres',sub:'En situation réelle / En situación real',type:'dialog',
   situations:[
    ...
    {label:'Sit. 2',title:'Dar el número de teléfono',img:'📱',dialogue:[
      {s:'Amiga',fr:'C\'est quoi ton numéro de téléphone ?',tr:'¿Cuál es tu número de celular?',side:'right'},
      {s:'María',fr:'C\'est le zéro six, trente-deux, quinze, vingt, onze.',tr:'Es el 06 32 15 20 11.',side:'left'},
      {s:'Amiga',fr:'Zéro six, trente-deux... tu peux répéter ?',tr:'Cero seis, treinta y dos... ¿podés repetir?',side:'right'},
    ...
    {label:'Sit. 3',title:'Decir cuántas personas',img:'👥',dialogue:[
      ...
      {s:'Pedro',fr:'Nous sommes quatre : deux adultes et deux enfants.',tr:'Somos cuatro: dos adultos y dos chicos.',side:'left'},
      {s:'Anfitriona',fr:'Très bien. Vous avez réservé ?',tr:'Muy bien. ¿Tienen reserva?',side:'right'},
      {s:'Pedro',fr:'Oui, au nom de Rodriguez. Pour vingt heures.',tr:'Sí, a nombre de Rodríguez. Para las ocho de la noche.',side:'left'}
    ]}
   ],
  ...
  {id:'col2',level:2,emoji:'🎨',name:'Les Couleurs',sub:'En situation réelle / En situación real',type:'dialog',
   situations:[
    {label:'Sit. 1',title:'Color de una prenda',img:'👗',dialogue:[
      ...
      {s:'Luisa',fr:'Oui ! Elle est très belle. C\'est quelle couleur exactement ?',tr:'¡Sí! Es muy lindo. ¿De qué color es exactamente?',side:'left'},
      {s:'Amiga',fr:'C\'est violet avec des fleurs roses.',tr:'Es violeta con flores rosas.',side:'right'},
      {s:'Luisa',fr:'C\'est magnifique ! Le rose te va très bien.',tr:'¡Qué copado! El rosado te queda muy bien.',side:'left'}
    ]},
    ...
    {label:'Sit. 3',title:'Elegir un color de pintura',img:'🖌️',dialogue:[
      ...
      {s:'Ana',fr:'Je voudrais quelque chose de clair. Peut-être blanc cassé.',tr:'Quisiera algo claro. Quizás blanco marfil.',side:'left'},
      {s:'Vendedor',fr:'Voici le blanc, le beige et le gris clair.',tr:'Acá tiene el blanco, el beige y el gris claro.',side:'right'},
  ...
  {id:'nour2',level:2,emoji:'🍽️',name:'La Nourriture',sub:'Marché, resto, courses / Mercado, restaurante',type:'dialog',
   situations:[
    {label:'Sit. 1',title:'En el mercado',img:'🥦',dialogue:[
      ...
      {s:'Vendedor',fr:'Voilà, c\'est trois euros.',tr:'Acá tiene, son tres euros.',side:'right'}
    ]},
    {label:'Sit. 2',title:'En el restaurante',img:'🍴',dialogue:[
      {s:'Mozo',fr:'Vous avez choisi ?',tr:'¿Ya saben qué van a pedir?',side:'right'},
      {s:'Carlos',fr:'Oui. Je voudrais le poulet avec du riz, s\'il vous plaît.',tr:'Sí. Quisiera el pollo con arroz, por favor.',side:'left'},
      {s:'Mozo',fr:'Et comme boisson ?',tr:'¿Y para tomar?',side:'right'},
      {s:'Carlos',fr:'Une carafe d\'eau, s\'il vous plaît.',tr:'Una jarra de agua, por favor.',side:'left'}
    ]},
    {label:'Sit. 3',title:'Lista de compras',img:'🛒',dialogue:[
      {s:'Luisa',fr:'Je dois faire les courses. Tu as besoin de quelque chose ?',tr:'Tengo que ir al súper. ¿Necesitás algo?',side:'left'},
      {s:'Pedro',fr:'Achète du pain et des œufs.',tr:'Comprá pan y huevos.',side:'right'},
      {s:'Luisa',fr:'D\'accord. Je voudrais aussi du fromage blanc pour faire des empanadas.',tr:'Bueno. También quiero queso blanco para hacer empanadas.',side:'left'},
      {s:'Pedro',fr:'Bonne idée ! Et n\'oublie pas le beurre.',tr:'¡Buena idea! Y no te olvides de la mantequilla.',side:'right'}
    ]}
   ],
   vocab:['Je voudrais = Quisiera / me gustaría','Combien ? = ¿Cuánto?','Un kilo = Un kilo','C\'est combien ? = ¿Cuánto es? / ¿Cuánto cuesta?','Les courses = Las compras / el súper','Vous avez choisi ? = ¿Ya eligieron?'],
   quiz:[
  ...
  {id:'bois2',level:2,emoji:'🥤',name:'Les Boissons',sub:'Comptoir, invité, supermarché',type:'dialog',
   situations:[
    {label:'Sit. 1',title:'Pedir en el mostrador',img:'☕',dialogue:[
      ...
      {s:'Barista',fr:'Voilà, c\'est un euro cinquante.',tr:'Acá tiene, es un euro con cincuenta.',side:'right'}
    ]},
    {label:'Sit. 2',title:'Ofrecer bebida a un invitado',img:'🍹',dialogue:[
      {s:'Anfitrión',fr:'Qu\'est-ce que tu veux boire ?',tr:'¿Qué querés tomar?',side:'right'},
   ...
   vocab:['Vous désirez ? = ¿Qué desea?','Sans sucre = Sin azúcar','Eau plate = Agua natural / sin gas','Eau gazeuse = Agua con gas','Un pack = Un pack / un paquete','Le rayon = El pasillo / la sección'],
   quiz:[
  ...
  {id:'fam2',level:2,emoji:'👨‍👩‍👧',name:'La Famille',sub:'Photos, frères, enfants / Fotos, hermanos, hijos',type:'dialog',
   situations:[
    {label:'Sit. 1',title:'Presentar la familia en una foto',img:'📷',dialogue:[
      ...
      {s:'Ana',fr:'Ils sont adorables ! Tu as combien d\'enfants ?',tr:'¡Qué re lindos! ¿Cuántos hijos tenés?',side:'right'},
      {s:'Luisa',fr:'Trois : deux fils et une fille.',tr:'Tres: dos varones y una nena.',side:'left'},
      {s:'Ana',fr:'Et tes parents, ils sont en Argentine ?',tr:'¿Y tus padres, están en Argentina?',side:'right'},
      {s:'Luisa',fr:'Oui, ma mère et mon père vivent à Buenos Aires.',tr:'Sí, mi mamá y mi papá viven en Buenos Aires.',side:'left'}
    ]},
    {label:'Sit. 2',title:'Hermanos y hermanas',img:'👫',dialogue:[
      {s:'Vecina',fr:'Tu as des frères et sœurs ?',tr:'¿Tenés hermanos?',side:'right'},
      {s:'Pedro',fr:'Oui, j\'ai deux frères et une sœur.',tr:'Sí, tengo dos hermanos y una hermana.',side:'left'},
      {s:'Vecina',fr:'Tu es l\'aîné ou le plus jeune ?',tr:'¿Sos el mayor o el menor?',side:'right'},
   ...
   quiz:[
    ...
    {q:'¿Qué significa "Comment vont tes enfants ?"?',opts:['¿Dónde están tus hijos?','¿Cuántos hijos tenés?','¿Cómo están tus hijos?','¿Qué edad tienen?'],ans:2}
   ]},
  {id:'emot2',level:2,emoji:'😄',name:'Les Émotions',sub:'Tristesse, fatigue, joie / Tristeza, cansancio, alegría',type:'dialog',
   situations:[
    {label:'Sit. 1',title:'¿Por qué está triste un amigo?',img:'😢',dialogue:[
      ...
      {s:'Ana',fr:'Je suis vraiment désolée. Je suis là si tu as besoin.',tr:'Lo siento mucho. Acá estoy si me necesitás.',side:'right'}
    ]},
    {label:'Sit. 2',title:'Expresar cansancio',img:'😴',dialogue:[
      {s:'Pareja',fr:'Tu rentres tard ! Tu es fatigué ?',tr:'¡Llegás tarde! ¿Estás cansado?',side:'right'},
      {s:'Pedro',fr:'Oui, je suis épuisé. C\'était une longue journée.',tr:'Sí, estoy agotado. Fue un día muy largo.',side:'left'},
      {s:'Pareja',fr:'Tu veux manger quelque chose ?',tr:'¿Querés comer algo?',side:'right'},
    ...
    {label:'Sit. 3',title:'Alegría por una buena noticia',img:'🎉',dialogue:[
      {s:'Luisa',fr:'J\'ai une grande nouvelle !',tr:'¡Tengo una noticia increíble!',side:'left'},
      {s:'Amiga',fr:'Dis-moi ! Tu as l\'air super contente !',tr:'¡Decime! ¡Se te ve re contenta!',side:'right'},
      {s:'Luisa',fr:'J\'ai trouvé du travail ! Je suis tellement joyeuse !',tr:'¡Conseguí trabajo! ¡Estoy felicísima!',side:'left'},
      {s:'Amiga',fr:'C\'est fantastique ! Je suis très heureuse pour toi !',tr:'¡Qué copado! ¡Estoy muy feliz por vos!',side:'right'}
    ]}
   ],
   vocab:['Triste = Triste','Fatigué(e) = Cansado/a','Joyeux/se = Alegre / contento/a','Content(e) = Contento/a','Je suis désolé(e) = Lo siento / disculpá','Épuisé(e) = Agotado/a','Une bonne nouvelle = Una buena noticia'],
   quiz:[
  ...
  {id:'log2',level:2,emoji:'🏠',name:'Le Logement',sub:'Studio, objets, ménage / Departamento, objetos',type:'dialog',
   situations:[
    {label:'Sit. 1',title:'Visitar un departamento en alquiler',img:'🏢',dialogue:[
      ...
      {s:'María',fr:'C\'est lumineux ! Il y a des toilettes séparées ?',tr:'¡Qué luminoso! ¿El baño tiene inodoro aparte?',side:'left'},
      {s:'Propietario',fr:'Oui, les toilettes sont à côté de la salle de bain.',tr:'Sí, el inodoro está al lado del baño.',side:'right'},
      {s:'María',fr:'C\'est combien le loyer par mois ?',tr:'¿Cuánto es el alquiler mensual?',side:'left'},
    ...
    {label:'Sit. 2',title:'Buscar un objeto perdido',img:'🔍',dialogue:[
      ...
      {s:'Ana',fr:'No... regarde dans le salon.',tr:'No... fijate en la sala.',side:'left'},
      {s:'Pedro',fr:'Non, elles ne sont pas là.',tr:'No, no están ahí.',side:'right'},
      {s:'Ana',fr:'Essaie la cuisine, ou peut-être dans la chambre.',tr:'Probá en la cocina, o quizás en el cuarto.',side:'left'},
    ...
    {label:'Sit. 3',title:'Las tareas del hogar',img:'🧹',dialogue:[
      ...
      {s:'Carlos',fr:'D\'accord. Et toi tu fais quoi ?',tr:'Bueno. ¿Y vos qué hacés?',side:'right'},
   ...
   vocab:['Le loyer = El alquiler','La salle de bain = El baño','Les toilettes = El baño / el inodoro','Le salon = La sala','La cuisine = La cocina','La chambre = El cuarto / la habitación','Faire la vaisselle = Lavar los platos'],
   quiz:[
    {q:'¿Qué significa "Le loyer"?',opts:['El departamento','El alquiler','El cuarto','El contrato'],ans:1},
  ...
  {id:'veth2',level:2,emoji:'👗',name:'Les Vêtements',sub:'Matin, taille, veste perdue / Mañana, talle, ropa perdida',type:'dialog',
   situations:[
    {label:'Sit. 1',title:'Vestirse en la mañana',img:'🌅',dialogue:[
      ...
      {s:'Mamá',fr:'Il fait froid, mets ton manteau et ton écharpe.',tr:'Hace frío, ponete el abrigo y la bufanda.',side:'left'},
    ...
    {label:'Sit. 2',title:'Comprar en el talle correcto',img:'🏪',dialogue:[
      {s:'Vendedor',fr:'Bonjour, je peux vous aider ?',tr:'Buenos días, ¿le puedo ayudar?',side:'right'},
      {s:'Luisa',fr:'Oui, je cherche ce pantalon en taille quarante.',tr:'Sí, busco ese pantalón en talle cuarenta.',side:'left'},
      {s:'Vendedor',fr:'Un instant... voilà, en taille quarante.',tr:'Un momento... acá tiene, talle cuarenta.',side:'right'},
    ...
    {label:'Sit. 3',title:'Buscar una campera perdida',img:'🔍',dialogue:[
      {s:'Carlos',fr:'Excuse-moi, j\'ai oublié ma veste.',tr:'Disculpá, olvidé mi campera.',side:'left'},
      {s:'Mozo',fr:'De quelle couleur est-elle ?',tr:'¿De qué color es?',side:'right'},
      {s:'Carlos',fr:'Elle est noire, avec une fermeture éclair.',tr:'Es negra, con cierre.',side:'left'},
      {s:'Mozo',fr:'Attendez... voilà une veste noire.',tr:'Esperá... acá hay una campera negra.',side:'right'},
      {s:'Carlos',fr:'Oui c\'est la mienne ! Merci beaucoup !',tr:'¡Sí, esa es la mía! ¡Muchísimas gracias!',side:'left'}
    ]}
   ],
   vocab:['La veste = La campera / la chaqueta','Le manteau = El abrigo','La taille = El talle','Les chaussures = Los zapatos','La cabine d\'essayage = El probador','Il fait froid = Hace frío'],
   quiz:[
    {q:'¿Qué significa "La taille" (en ropa)?',opts:['El color','El precio','El talle','El modelo'],ans:2},
  ...
  {id:'corps2',level:2,emoji:'🧍',name:'Le Corps',sub:'Médecin, sport, physique / Médico, deporte, físico',type:'dialog',
   situations:[
    {label:'Sit. 1',title:'Explicarle al médico dónde duele',img:'🏥',dialogue:[
      ...
      {s:'Pedro',fr:'Depuis deux jours. J\'ai aussi mal au ventre.',tr:'Desde hace dos días. También me duele la panza.',side:'left'}
    ]},
    {label:'Sit. 2',title:'Lesión en el deporte',img:'⚽',dialogue:[
      {s:'Entrenador',fr:'Ça va ? Tu boites !',tr:'¿Estás bien? ¡Estás renqueando!',side:'right'},
    ...
    {label:'Sit. 3',title:'Describir el físico de alguien',img:'👤',dialogue:[
      ...
      {s:'Policía',fr:'Il a les cheveux de quelle couleur ?',tr:'¿De qué color tiene el pelo?',side:'right'},
      {s:'Ana',fr:'Il a les cheveux noirs, courts. Et il a une barbe.',tr:'Tiene el pelo negro, corto. Y tiene barba.',side:'left'}
    ]}
   ],
  ...
  {id:'anim2',level:2,emoji:'🐘',name:'Les Animaux',sub:'Mascotte, rue, ferme / Mascota, calle, campo',type:'dialog',
   situations:[
    {label:'Sit. 1',title:'Hablar de tu mascota',img:'🐶',dialogue:[
      {s:'Vecino',fr:'C\'est ton chien ? Il est beau !',tr:'¿Ese es tu perro? ¡Qué lindo!',side:'right'},
      ...
      {s:'Luisa',fr:'Il a trois ans. Il est très gentil.',tr:'Tiene tres años. Es muy buenito.',side:'left'},
    ...
    {label:'Sit. 3',title:'Visita al campo',img:'🐄',dialogue:[
      {s:'Granjero',fr:'Bienvenue à la ferme ! Voilà les vaches.',tr:'¡Bienvenidos al campo! Allá están las vacas.',side:'right'},
      ...
      {s:'Niño',fr:'Je peux monter à cheval ?',tr:'¿Puedo andar a caballo?',side:'left'},
      {s:'Granjero',fr:'Oui, avec le casque bien sûr !',tr:'Sí, ¡con el casco, claro!',side:'right'}
    ]}
   ],
   vocab:['Le chien = El perro','Le chat = El gato','La vache = La vaca','La poule = La gallina','Le cheval = El caballo','Il est doux = Es manso / tranquilo','La ferme = El campo / la estancia'],
   quiz:[
    {q:'¿Qué significa "Il est doux" (hablando de un animal)?',opts:['Es feo','Es manso','Es agresivo','Es grande'],ans:1},
    {q:'¿Cómo se dice "El campo / la estancia" en francés?',opts:['Le jardin','La forêt','La ferme','Le champ'],ans:2},
  ...
  {id:'verb2',level:2,emoji:'📝',name:'Les Verbes Principaux',sub:'Routine, goûts, actions / Rutina, gustos, acciones',type:'dialog',
   situations:[
    {label:'Sit. 1',title:'Rutina diaria',img:'⏰',dialogue:[
      {s:'Colega',fr:'Tu te lèves à quelle heure ?',tr:'¿A qué hora te levantás?',side:'right'},
      ...
      {s:'Colega',fr:'Et le soir, tu fais quoi ?',tr:'¿Y a la noche qué hacés?',side:'right'},
    ...
    {label:'Sit. 2',title:'Expresar gustos',img:'❤️',dialogue:[
      ...
      {s:'Luisa',fr:'Oui, j\'aime beaucoup ! Je mange souvent du fromage.',tr:'¡Sí, me encanta! Como queso seguido.',side:'left'},
  ...
  {id:'pays2',level:2,emoji:'🌍',name:'Les Pays',sub:'Nationalité, vacances, rêves / Nacionalidad, vacaciones',type:'dialog',
   situations:[
    {label:'Sit. 1',title:'Preguntar la nacionalidad',img:'🗺️',dialogue:[
      ...
      {s:'Ana',fr:'Je viens d\'Argentine. Et vous ?',tr:'Soy de Argentina. ¿Y usted?',side:'left'},
      {s:'Vecina',fr:'Je suis française, de Lyon.',tr:'Soy francesa, de Lyon.',side:'right'},
      {s:'Ana',fr:'Ah ! Et vous connaissez l\'Uruguay aussi ?',tr:'¡Ah! ¿Y conoce Uruguay también?',side:'left'},
    ...
    {label:'Sit. 2',title:'Hablar de las últimas vacaciones',img:'🏖️',dialogue:[
      ...
      {s:'Colega',fr:'C\'était bien ?',tr:'¿Estuvo bueno?',side:'right'},
    ...
    {label:'Sit. 3',title:'Decir a dónde viajaría',img:'✈️',dialogue:[
      ...
      {s:'Luisa',fr:'Oh ! C\'est un pays magnifique. J\'aime aussi l\'Italie.',tr:'¡Ay! Ese país es precioso. También me gusta Italia.',side:'left'}
    ]}
   ],
  ...
  {id:'plan2',level:2,emoji:'🌿',name:'Les Plantes',sub:'Fleuriste, maison, parc / Floristería, casa, parque',type:'dialog',
   situations:[
    ...
    {label:'Sit. 2',title:'Regar las plantas de la casa',img:'🪴',dialogue:[
      {s:'Vecina',fr:'Tu peux arroser mes plantes cette semaine ?',tr:'¿Podés regar mis plantas esta semana?',side:'right'},
      {s:'Luisa',fr:'Bien sûr ! Combien de fois par jour ?',tr:'¡Claro! ¿Cuántas veces por día?',side:'left'},
      {s:'Vecina',fr:'Une fois par jour, le matin.',tr:'Una vez por día, a la mañana.',side:'right'},
    ...
    {label:'Sit. 3',title:'Paseo en el parque',img:'🌳',dialogue:[
      {s:'Pedro',fr:'Regarde ces arbres, ils sont magnifiques !',tr:'¡Mirá esos árboles, son preciosos!',side:'right'},
      {s:'Ana',fr:'Oui ! Et les fleurs dans le jardin sont belles aussi.',tr:'¡Sí! Y las flores del jardín también son lindas.',side:'left'},
  ...
  {id:'salut2',level:2,emoji:'👋',name:'Les Salutations',sub:'Magasin, voisin, départ / Tienda, vecino, despedida',type:'dialog',
   situations:[
    {label:'Sit. 1',title:'Entrar a un negocio',img:'🏪',dialogue:[
      {s:'Cliente',fr:'Bonjour !',tr:'¡Buen día!',side:'left'},
      {s:'Vendedor',fr:'Bonjour ! Bienvenue. Je peux vous aider ?',tr:'¡Buen día! Bienvenido. ¿Le puedo ayudar?',side:'right'},
    ...
    {label:'Sit. 2',title:'Ver al vecino en el ascensor',img:'🛗',dialogue:[
      {s:'Vecino',fr:'Bonsoir ! Vous rentrez tard ce soir.',tr:'¡Buenas noches! Llega tarde esta noche.',side:'right'},
    ...
    {label:'Sit. 3',title:'Despedirse antes de irse',img:'🚪',dialogue:[
      ...
      {s:'Pedro',fr:'Déjà ? Bonne route ! Et fais attention.',tr:'¿Ya? ¡Que te vaya bien! Y tené cuidado.',side:'right'},
      {s:'Ana',fr:'Merci ! À bientôt ! Embrasse ta famille !',tr:'¡Gracias! ¡Hasta pronto! ¡Saludá a tu familia!',side:'left'},
      {s:'Pedro',fr:'Bonne nuit ! Prends soin de toi !',tr:'¡Buenas noches! ¡Cuidate!',side:'right'}
    ]}
   ],
   vocab:['Bonjour = Buen día / buenas','Bonsoir = Buenas tardes / buenas noches','Au revoir = Adiós / chau','À bientôt = Hasta pronto / hasta luego','Bonne nuit = Buenas noches','Merci = Gracias','S\'il vous plaît = Por favor'],
   quiz:[
  ...
  {id:'met2',level:2,emoji:'💼',name:'Les Professions',sub:'Demander, expliquer, rêver / Preguntar, explicar, soñar',type:'dialog',
   situations:[
    {label:'Sit. 1',title:'Preguntar la profesión',img:'🤝',dialogue:[
      ...
      {s:'Vecina',fr:'Ah, comme c\'est bien ! Et vous travaillez le week-end ?',tr:'¡Qué bueno! ¿Y trabaja los fines de semana?',side:'right'},
      {s:'Carlos',fr:'Oui, souvent. C\'est mon métier depuis dix ans.',tr:'Sí, seguido. Es mi oficio desde hace diez años.',side:'left'}
    ]},
    {label:'Sit. 2',title:'Hablar del trabajo actual',img:'💻',dialogue:[
      {s:'Amiga',fr:'Tu travailles où maintenant ?',tr:'¿Dónde trabajás ahora?',side:'right'},
      ...
      {s:'María',fr:'Non, vingt minutes en bus. J\'aime beaucoup mon travail.',tr:'No, veinte minutos en colectivo. Me encanta mi trabajo.',side:'left'}
    ]},
    {label:'Sit. 3',title:'El trabajo de los sueños',img:'🌟',dialogue:[
      ...
      {s:'Profe',fr:'C\'est un beau métier ! Et toi, Luisa ?',tr:'¡Qué lindo oficio! ¿Y vos, Luisa?',side:'right'},
  ...
  {id:'trans2',level:2,emoji:'🚌',name:'Les Transports',sub:'Bus, taxi, train / Colectivo, taxi, tren',type:'dialog',
   situations:[
    {label:'Sit. 1',title:'Comprar un boleto de colectivo',img:'🚌',dialogue:[
      {s:'Luisa',fr:'Bonjour, un ticket pour le centre-ville, s\'il vous plaît.',tr:'Buen día, un boleto para el centro, por favor.',side:'left'},
      {s:'Chofer',fr:'Voilà, c\'est un euro soixante.',tr:'Acá tiene, es un euro con sesenta.',side:'right'},
      {s:'Luisa',fr:'Je n\'ai pas de monnaie. Je peux payer avec cinq euros ?',tr:'No tengo suelto. ¿Puedo pagar con cinco euros?',side:'left'},
      {s:'Chofer',fr:'Oui, voilà votre monnaie.',tr:'Sí, acá tiene su vuelto.',side:'right'}
    ]},
    {label:'Sit. 2',title:'Pedir un remis',img:'🚕',dialogue:[
      {s:'Pedro',fr:'Bonjour, je voudrais un taxi pour l\'aéroport.',tr:'Buen día, quisiera un remis para el aeropuerto.',side:'left'},
      {s:'Operador',fr:'D\'accord. C\'est à quelle adresse ?',tr:'Bueno. ¿Cuál es la dirección?',side:'right'},
      {s:'Pedro',fr:'Quinze rue de la Paix, dans le troisième arrondissement.',tr:'Calle de la Paz, número quince, en el tercer barrio.',side:'left'},
      {s:'Operador',fr:'Le taxi arrive dans dix minutes.',tr:'El remis llega en diez minutos.',side:'right'}
    ]},
    {label:'Sit. 3',title:'Validar el boleto en el andén',img:'🚂',dialogue:[
      ...
      {s:'Ana',fr:'Le voici. J\'ai une réservation pour Paris.',tr:'Acá tiene. Tengo reserva para París.',side:'left'},
   ...
   vocab:['Le ticket = El boleto / el ticket','La monnaie = El suelto / el vuelto','L\'aéroport = El aeropuerto','La gare = La estación de tren','Valider = Validar / sellar','Composter = Sellar el boleto','Le quai = El andén'],
   quiz:[
    {q:'¿Qué significa "Je n\'ai pas de monnaie"?',opts:['No tengo boleto','No tengo suelto','No tengo plata','No tengo tarjeta'],ans:1},
  ...
  {id:'lieux2',level:2,emoji:'🏙️',name:'Les Lieux Importants',sub:'Urgence, courses, campagne / Lugares importantes',type:'dialog',
   situations:[
    {label:'Sit. 1',title:'Buscar un edificio con urgencia',img:'🚨',dialogue:[
      ...
      {s:'Transeúnte',fr:'La pharmacie ? C\'est à deux rues d\'ici, à gauche.',tr:'¿La farmacia? Está a dos cuadras de acá, a la izquierda.',side:'right'},
      {s:'María',fr:'Et l\'hôpital, c\'est loin ?',tr:'¿Y el hospital, queda lejos?',side:'left'},
      {s:'Transeúnte',fr:'Oui, prenez le bus numéro quatre.',tr:'Sí, tome el colectivo número cuatro.',side:'right'}
    ]},
    {label:'Sit. 2',title:'Explicar a dónde ir de compras',img:'🛒',dialogue:[
      {s:'Vecina',fr:'Tu vas faire les courses ce matin ?',tr:'¿Vas al súper esta mañana?',side:'right'},
    ...
    {label:'Sit. 3',title:'Describir un fin de semana en el campo',img:'🌾',dialogue:[
      ...
      {s:'Colega',fr:'C\'est beau la campagne en été !',tr:'¡Qué lindo el campo en verano!',side:'right'},
      {s:'Pedro',fr:'Oui, et on s\'est promenés au bord de la rivière.',tr:'Sí, y caminamos a orillas del río.',side:'left'}
    ]}
   ],
   vocab:['La pharmacie = La farmacia','L\'hôpital = El hospital','Le supermarché = El supermercado / el súper','La banque = El banco','La campagne = El campo','La rivière = El río / el arroyo','La mairie = La municipalidad'],
   quiz:[
  ...
  {id:'orient2',level:2,emoji:'🧭',name:'S\'Orienter',sub:'Chemin, taxi, magasin / Camino, taxi, negocio',type:'dialog',
   situations:[
    ...
    {label:'Sit. 3',title:'Indicar dónde está un negocio',img:'🏪',dialogue:[
      {s:'Turista',fr:'Il y a une boulangerie près d\'ici ?',tr:'¿Hay una panadería cerca de acá?',side:'right'},
      ...
      {s:'Luisa',fr:'Allez tout droit, et c\'est à droite.',tr:'Siga recto y queda a la derecha.',side:'left'},
      {s:'Luisa',fr:'Non, c\'est très près, deux minutes à pied.',tr:'No, está muy cerca, a dos minutos caminando.',side:'left'}
    ]}
   ],
  ...
  {id:'sante2',level:2,emoji:'🏥',name:'La Santé',sub:'Médecin, symptômes, pharmacie / Médico, síntomas',type:'dialog',
   situations:[
    {label:'Sit. 1',title:'Pedir turno médico',img:'📅',dialogue:[
      {s:'Secretaria',fr:'Cabinet du docteur Lefebvre, bonjour.',tr:'Consultorio del doctor Lefebvre, buen día.',side:'right'},
      {s:'María',fr:'Bonjour, je voudrais prendre un rendez-vous, s\'il vous plaît.',tr:'Buen día, quisiera pedir un turno, por favor.',side:'left'},
    ...
    {label:'Sit. 2',title:'Explicar los síntomas al médico',img:'🩺',dialogue:[
      {s:'Médico',fr:'Bonjour, qu\'est-ce qui ne va pas aujourd\'hui ?',tr:'Buen día, ¿qué le pasa hoy?',side:'right'},
      ...
      {s:'Médico',fr:'Non, c\'est une angine. Je vous fais une ordonnance.',tr:'No es grave, es una angina. Le hago una receta.',side:'right'}
    ]},
    {label:'Sit. 3',title:'Comprar medicamentos en la farmacia',img:'💊',dialogue:[
      {s:'Luisa',fr:'Bonjour, j\'ai une ordonnance.',tr:'Buen día, traigo una receta.',side:'left'},
      {s:'Farmaceuta',fr:'Bonjour. Voici les médicaments. Prenez-en un le matin et un le soir.',tr:'Buen día. Acá tiene los medicamentos. Tome uno a la mañana y uno a la noche.',side:'right'},
      ...
      {s:'Farmaceuta',fr:'Oui, voici un sirop. Deux cuillères trois fois par jour.',tr:'Sí, acá tiene un jarabe. Dos cucharadas tres veces por día.',side:'right'}
    ]}
   ],
   vocab:['Un rendez-vous = Un turno médico','L\'ordonnance = La receta médica','Le médicament = El medicamento / la medicina','J\'ai mal à... = Me duele...','La fièvre = La fiebre','La toux = La tos','Le pharmacien = El/la farmacéutico/a'],
   quiz:[
    {q:'¿Cómo se dice "Un turno médico" en francés?',opts:['Une visite','Un rendez-vous','Une ordonnance','Une consultation'],ans:1},
  ...
  {id:'objets2',level:2,emoji:'🔑',name:'Objets du Quotidien',sub:'Clés, stylo, chargeur / Llaves, lapicera, cargador',type:'dialog',
   situations:[
    {label:'Sit. 1',title:'Buscar las llaves antes de salir',img:'🔍',dialogue:[
      {s:'Carlos',fr:'Attends, je ne trouve pas mes clés !',tr:'Esperá, ¡no encuentro mis llaves!',side:'left'},
      {s:'Ana',fr:'Tu as regardé dans ton sac à dos ?',tr:'¿Revisaste en la mochila?',side:'right'},
      ...
      {s:'Carlos',fr:'Ah oui ! Les voilà ! On peut partir maintenant.',tr:'¡Ah sí! ¡Acá están! Ya podemos irnos.',side:'left'},
      {s:'Ana',fr:'N\'oublie pas tes lunettes aussi !',tr:'¡No te olvides los anteojos tampoco!',side:'right'}
    ]},
    {label:'Sit. 2',title:'Pedir prestada una lapicera o papel',img:'✏️',dialogue:[
      {s:'Luisa',fr:'Excuse-moi, tu aurais un stylo à me prêter ?',tr:'Disculpá, ¿me podés prestar una lapicera?',side:'left'},
      {s:'Colega',fr:'Oui, bien sûr ! Tiens.',tr:'Sí, claro. Tomá.',side:'right'},
      {s:'Luisa',fr:'Merci ! Et tu aurais aussi une feuille de papier ?',tr:'¡Gracias! ¿Y también tenés una hoja de papel?',side:'left'},
      {s:'Colega',fr:'Oui, voilà. Tu en as besoin pour longtemps ?',tr:'Sí, acá tenés. ¿La necesitás por mucho tiempo?',side:'right'},
    ...
    {label:'Sit. 3',title:'Pedir un cargador de celular',img:'🔌',dialogue:[
      {s:'Pedro',fr:'Mon téléphone est presque mort. Tu as un chargeur ?',tr:'Mi celular está casi sin batería. ¿Tenés un cargador?',side:'left'},
      {s:'María',fr:'Quel modèle de téléphone tu as ?',tr:'¿Qué modelo de celular tenés?',side:'right'},
      {s:'Pedro',fr:'Un Samsung. Tu aurais un chargeur USB-C ?',tr:'Un Samsung. ¿Tendrás un cargador USB-C?',side:'left'},
      {s:'María',fr:'Oui ! Le voilà. Tu peux le garder une heure.',tr:'¡Sí! Acá está. Lo podés tener una hora.',side:'right'},
      {s:'Pedro',fr:'Merci beaucoup, tu me sauves la vie !',tr:'¡Muchísimas gracias, me salvaste la vida!',side:'left'}
    ]}
   ],
   vocab:['Les clés = Las llaves','Le portefeuille = La billetera','Le sac à dos = La mochila','Le stylo = La lapicera / el bolígrafo','La feuille = La hoja de papel','Le chargeur = El cargador','Les lunettes = Los anteojos'],
   quiz:[
    {q:'¿Cómo se dice "Las llaves" en francés?',opts:['Le portefeuille','Les clés','Le stylo','La bouteille'],ans:1},
    {q:'¿Qué significa "Tu as un chargeur ?"?',opts:['¿Tenés un cable?','¿Tenés un cargador?','¿Tenés un celular?','¿Tenés batería?'],ans:1},
    {q:'¿Qué significa "Tu me sauves la vie !"?',opts:['¡Me das la vida!','¡Me ayudás!','¡Me salvaste la vida!','¡Sos genial!'],ans:2}
   ]}
];
