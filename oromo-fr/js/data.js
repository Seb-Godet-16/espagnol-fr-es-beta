...
var LEVEL1_THEMES=[
  {id:'alpha',level:1,emoji:'🔤',name:'Qubee',sub:'A, B, C… Z / L\'alphabet',type:'alpha',
   words:[
   ...
   quiz10:[
    {q:'Qubee kamtu dhagayamti?',audio:'B',opts:['A','B','C','D'],ans:1},
    {q:'Qubee kamtu dhagayamti?',audio:'G',opts:['J','K','G','H'],ans:2},
    {q:'Qubee kamtu dhagayamti?',audio:'Ñ',opts:['N','Ñ','M','L'],ans:1},
    {q:'Qubee kamtu dhagayamti?',audio:'R',opts:['A','R','L','N'],ans:1},
    {q:'Qubee kamtu dhagayamti?',audio:'Z',opts:['S','X','Z','C'],ans:2},
    {q:'Qubee kamtu dhagayamti?',audio:'H',opts:['H','F','M','N'],ans:0},
    {q:'Qubee kamtu dhagayamti?',audio:'K',opts:['C','G','K','Q'],ans:2},
    {q:'Qubee kamtu dhagayamti?',audio:'Y',opts:['I','U','Y','E'],ans:2},
    {q:'Qubee kamtu dhagayamti?',audio:'W',opts:['V','W','X','Y'],ans:1},
    {q:'Qubee kamtu dhagayamti?',audio:'P',opts:['B','D','P','T'],ans:2}
   ]},
