...
*Métriques revérifiées le 12/07/2026 (voir § 8 Historique)*
...
| Poids total source | ~724 Ko (14 070 lignes de code, hors manifest/deploy) |
| Chargement initial | ~482 Ko (app.js + style.css + index.html), les données chargées à la demande |
...
|---|---|---|---|
| `app.js` | 5 266 | 249 Ko | Moteur applicatif — 167 fonctions, 21 sections |
| `style.css` | 4 638 | 157 Ko | Thèmes, composants, animations — 48 variables CSS uniques (171 déclarations, redéfinies par thème/variante) |
...
| `index.html` | 1 174 | 75,7 Ko | Structure HTML (4 écrans + 2 modales) |
