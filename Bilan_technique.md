...
*Métriques revérifiées le 13/07/2026 (voir § 8 Historique)*
...
| Poids total source | ~730 Ko (14 187 lignes de code, hors manifest/deploy) |
| Chargement initial | ~490 Ko (app.js + style.css + index.html), les données chargées à la demande |
...
|---|---|---|---|
| `app.js` | 5 295 | 250,3 Ko | Moteur applicatif — 167 fonctions, 21 sections |
| `style.css` | 4 671 | 158,7 Ko | Thèmes, composants, animations — 48 variables CSS uniques (171 déclarations, redéfinies par thème/variante) |
...
| `index.html` | 1 229 | 80,6 Ko | Structure HTML (4 écrans + 2 modales) |
