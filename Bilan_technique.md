...
*Métriques revérifiées le 11/07/2026 (voir § 8 Historique)*
...
| Poids total source | ~699 Ko (13 898 lignes de code, hors manifest/deploy) |
| Chargement initial | ~464 Ko (app.js + style.css + index.html), les données chargées à la demande |
...
|---|---|---|---|
| `app.js` | 5 176 | 238 Ko | Moteur applicatif — 162 fonctions, 21 sections |
| `style.css` | 4 556 | 150 Ko | Thèmes, composants, animations — 44 variables CSS uniques (161 déclarations, redéfinies par thème/variante) |
