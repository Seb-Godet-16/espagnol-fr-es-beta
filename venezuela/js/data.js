/* ========================================
   Français → Español Venezuela 🇻🇪 – Données
...
var LEVEL1_THEMES=[
  ...
  {id:'pres',level:1,emoji:'🙋',name:'Se Présenter',sub:'Nom, âge, pays… / Presentarse',
   words:[
    ...
    {fr:'Français(e)',es:'Francés / francesa',em:'🇫🇷'},{fr:'Vénézuélien(ne)',es:'Venezolano / venezolana',em:'🇻🇪'},
   ...
   quiz10:[
    ...
    {q:'¿Cómo se dice "Soy venezolano" en francés?',opts:['Je suis français','Je suis vénézuélien','J\'habite Venezuela','Je parle venezolano'],ans:1},
  ...
  {id:'nour',level:1,emoji:'🍽️',name:'La Nourriture',sub:'Pain, légumes, fruits… / La comida',
   words:[
    ...
    {fr:'La pomme',es:'La manzana',em:'🍎'},{fr:'La banane',es:'El cambur',em:'🍌'},
    {fr:'La tomate',es:'El tomate / el jitomato',em:'🍅'},{fr:'La carotte',es:'La zanahoria',em:'🥕'},
    ...
    {fr:'La pomme de terre',es:'La papa',em:'🥔'},{fr:'Le maïs',es:'El maíz / el jojoto',em:'🌽'},
    ...
    {fr:'La fraise',es:'La fresa / la frutilla',em:'🍓'},{fr:'La pastèque',es:'La patilla',em:'🍉'},
    {fr:'Les cacahuètes',es:'El maní',em:'🥜'},
    {fr:'Le chocolat',es:'El chocolate',em:'🍫'},{fr:'Le miel',es:'La miel',em:'🍯'},
    {fr:'La citrouille',es:'La auyama',em:'🎃'},{fr:'Les haricots',es:'Las caraotas',em:'🫘'}
   ],
   quiz10:[
    ...
    {q:'¿Cómo se llama "cambur" en francés?',opts:['La pomme','La fraise','La banane','L\'orange'],ans:2},
    {q:'¿Cómo se llama "auyama" en francés?',opts:['La carotte','La citrouille','Le maïs','L\'oignon'],ans:1},
    {q:'¿Cómo se llama "caraotas" en francés?',opts:['Les pâtes','Les cacahuètes','Les haricots','Le riz'],ans:2},
    {q:'¿Cómo se llama "patilla" en francés?',opts:['La fraise','La pastèque','Le raisin','L\'orange'],ans:1},
  ...
  {id:'bois',level:1,emoji:'🥤',name:'Les Boissons',sub:'Eau, café, jus… / Las bebidas',
   words:[
    ...
    {fr:'La bière',es:'La cerveza',em:'🍺'},{fr:'Le soda',es:'El refresco / la gaseosa',em:'🥤'},
  ...
  {id:'emot',level:1,emoji:'😄',name:'Les Émotions',sub:'Joyeux, triste… / Las emociones',
   words:[
    ...
    {fr:'Stressé(e)',es:'Estresado / agobiado',em:'😰'},{fr:'Malade',es:'Enfermo / maluco',em:'🤒'},
  ...
  {id:'veth',level:1,emoji:'👗',name:'Les Vêtements',sub:'T-shirt, pantalon… / La ropa',
   words:[
    ...
    {fr:'La culotte',es:'La blúmer / la pantaleta',em:'🩲'}
   ],
   quiz10:[
  ...
  {id:'anim',level:1,emoji:'🐘',name:'Les Animaux',sub:'Chat, chien, cheval… / Los animales',
   words:[
    ...
    {fr:'Le moustique',es:'El zancudo / el mosquito',em:'🦟'},
   ...
   quiz10:[
    ...
    {q:'¿Cómo se dice "El zancudo" en francés?',opts:['La fourmi','Le papillon','L\'araignée','Le moustique'],ans:3},
  ...
  {id:'pays',level:1,emoji:'🌍',name:'Les Pays',sub:'France, Venezuela… / Los países',
   words:[
    {fr:'La France',es:'Francia',em:'🇫🇷'},{fr:'Le Venezuela',es:'Venezuela',em:'🇻🇪'},
  ...
  {id:'salut',level:1,emoji:'👋',name:'Les Salutations',sub:'Bonjour, merci… / Los saludos',
   words:[
    ...
    {fr:'Salut',es:'Hola / épale (informal)',em:'👋'},{fr:'Au revoir',es:'Adiós / chao',em:'👋'},
    ...
    {fr:'Non',es:'No',em:'❌'},{fr:'Comment ça va ?',es:'¿Cómo estás? / ¿Qué más?',em:'🤗'},
    {fr:'Je vais bien, merci',es:'Estoy bien, gracias',em:'😊'},
    {fr:'Super !',es:'¡Chévere! / ¡Genial!',em:'🌟'}
   ],
   quiz10:[
  ...
  {id:'met',level:1,emoji:'💼',name:'Les Professions',sub:'Médecin, cuisinier… / Las profesiones',
   words:[
    ...
    {fr:'Le vendeur',es:'El/la vendedor(a)',em:'🏪'},{fr:'Le serveur',es:'El/la mesonero(a)',em:'🍽️'},
  ...
  {id:'trans',level:1,emoji:'🚌',name:'Les Transports',sub:'Bus, train, vélo… / Los transportes',
   words:[
    ...
    {fr:'La voiture',es:'El carro / el coche',em:'🚗'},{fr:'Le vélo',es:'La bicicleta / el velocípedo',em:'🚴'},
    {fr:'Le métro',es:'El metro',em:'🚇'},{fr:'Le taxi',es:'El taxi / el libre',em:'🚕'},
  ...
  {id:'lieux',level:1,emoji:'🏙️',name:'Les Lieux Importants',sub:'Marché, hôpital… / Los lugares',
   words:[
    ...
    {fr:'La banque',es:'El banco',em:'🏦'},{fr:'La pharmacie',es:'La farmacia / la droguería',em:'💊'},
    {fr:'L\'église',es:'La iglesia',em:'⛪'},{fr:'La mairie',es:'La alcaldía / la prefectura',em:'🏛️'},
    {fr:'Le champ',es:'El campo / la sabana',em:'🌾'},{fr:'La rivière',es:'El río / la quebrada',em:'🏞️'},
   ...
   quiz10:[
    ...
    {q:'¿Qué significa "Le supermarché"?',opts:['El mercado','El supermercado','La tienda','El abasto'],ans:1},
  ...
  {id:'sante',level:1,emoji:'🏥',name:'La Santé',sub:'Médecin, pharmacie… / La salud',
   words:[
    ...
    {fr:'Avoir mal',es:'Tener dolor / doler',em:'🤕'},{fr:'La fièvre',es:'La fiebre / el calentón',em:'🌡️'},
    {fr:'La toux',es:'La tos',em:'😮‍💨'},{fr:'La pharmacie',es:'La farmacia / la droguería',em:'🏪'},
  ...
  {id:'objets',level:1,emoji:'🔑',name:'Objets du Quotidien',sub:'Téléphone, clés… / Objetos del día',
   words:[
    ...
    {fr:'Les clés',es:'Las llaves',em:'🔑'},{fr:'Le portefeuille',es:'La billetera / el portamonedas',em:'👛'},
    {fr:'Le sac à dos',es:'La mochila / el morral',em:'🎒'},
    {fr:'Les lunettes',es:'Los lentes / los espejuelos',em:'👓'},
    {fr:'Le papier',es:'El papel',em:'📄'},{fr:'Le stylo',es:'El bolígrafo / la pluma / el lapicero',em:'🖊️'},
    {fr:'Les ciseaux',es:'Las tijeras',em:'✂️'},{fr:'Le chargeur',es:'El cargador',em:'🔌'},
    {fr:'La bouteille',es:'La botella / el pote',em:'🍶'}
   ],
   quiz10:[
    ...
    {q:'¿Cómo se dice "La mochila / el morral" en francés?',opts:['Le portefeuille','Le sac à main','Le sac à dos','Le chapeau'],ans:2},
    {q:'¿Qué significa "Le chargeur"?',opts:['El cable','El adaptador','El cargador','La batería'],ans:2},
    {q:'¿Cómo se dice "El bolígrafo" en francés?',opts:['Le crayon','Le papier','Le stylo','Le livre'],ans:2},
...
var LEVEL2_THEMES=[
   ...
   situations:[
    {label:'Sit. 1',title:'Encuentro amistoso',img:'🤝',
     dialogue:[
      ...
      {s:'Pedro',fr:'Moi c\'est Pedro. Je viens du Venezuela.',tr:'Yo soy Pedro. Vengo de Venezuela.',side:'right'},
      {s:'Ana',fr:'Ah super ! Tu habites à Lyon ?',tr:'¡Qué chévere! ¿Vives en Lyon?',side:'left'},
    ...
    {label:'Sit. 2',title:'Ámbito profesional',img:'💼',
     dialogue:[
      ...
      {s:'Carlos',fr:'Je suis ingénieur. Je viens de Caracas.',tr:'Soy ingeniero. Vengo de Caracas.',side:'left'},
    ...
    {label:'Sit. 3',title:'Llegada a una escuela',img:'🏫',
     dialogue:[
      ...
      {s:'Luisa',fr:'Je suis vénézuélienne. J\'ai trente ans.',tr:'Soy venezolana. Tengo treinta años.',side:'left'},
  ...
  {id:'col2',level:2,emoji:'🎨',name:'Les Couleurs',sub:'En situation réelle / En situación real',type:'dialog',
   situations:[
    {label:'Sit. 1',title:'Color de una prenda',img:'👗',dialogue:[
      ...
      {s:'Luisa',fr:'C\'est magnifique ! Le rose te va très bien.',tr:'¡Qué chévere! El rosado te queda muy bien.',side:'left'}
    ]},
    {label:'Sit. 2',title:'Color de un carro perdido',img:'🚗',dialogue:[
      {s:'Policía',fr:'C\'est quoi votre voiture ?',tr:'¿Cómo es su carro?',side:'right'},
      {s:'Marco',fr:'C\'est une voiture rouge, une Renault.',tr:'Es un carro rojo, un Renault.',side:'left'},
  ...
  {id:'nour2',level:2,emoji:'🍽️',name:'La Nourriture',sub:'Marché, resto, courses / Mercado, restaurante',type:'dialog',
   situations:[
    ...
    {label:'Sit. 2',title:'En el restaurante',img:'🍴',dialogue:[
      {s:'Mesonero',fr:'Vous avez choisi ?',tr:'¿Ya saben qué van a pedir?',side:'right'},
      {s:'Carlos',fr:'Oui. Je voudrais le poulet avec du riz, s\'il vous plaît.',tr:'Sí. Quisiera el pollo con arroz, por favor.',side:'left'},
      {s:'Mesonero',fr:'Et comme boisson ?',tr:'¿Y para tomar?',side:'right'},
    ...
    {label:'Sit. 3',title:'Lista de compras',img:'🛒',dialogue:[
      ...
      {s:'Luisa',fr:'D\'accord. Je voudrais aussi du fromage blanc pour faire des arepas.',tr:'Bueno. También quiero queso blanco para hacer arepas.',side:'left'},
  ...
  {id:'bois2',level:2,emoji:'🥤',name:'Les Boissons',sub:'Comptoir, invité, supermarché',type:'dialog',
   ...
   vocab:['Vous désirez ? = ¿Qué desea?','Sans sucre = Sin azúcar','Eau plate = Agua natural / sin gas','Eau gazeuse = Agua con gas','Un pack = Un paquete / un pack','Le rayon = El pasillo / la sección'],
   quiz:[
  ...
  {id:'fam2',level:2,emoji:'👨‍👩‍👧',name:'La Famille',sub:'Photos, frères, enfants / Fotos, hermanos, hijos',type:'dialog',
   situations:[
    {label:'Sit. 1',title:'Presentar la familia en una foto',img:'📷',dialogue:[
      ...
      {s:'Ana',fr:'Ils sont adorables ! Tu as combien d\'enfants ?',tr:'¡Qué chéveres! ¿Cuántos hijos tienes?',side:'right'},
      {s:'Luisa',fr:'Trois : deux fils et une fille.',tr:'Tres: dos varones y una hembra.',side:'left'},
      {s:'Ana',fr:'Et tes parents, ils sont au Venezuela ?',tr:'¿Y tus papás, están en Venezuela?',side:'right'},
      {s:'Luisa',fr:'Oui, ma mère et mon père vivent à Caracas.',tr:'Sí, mi mamá y mi papá viven en Caracas.',side:'left'}
    ]},
    ...
    {label:'Sit. 3',title:'Preguntar por los hijos',img:'🧒',dialogue:[
      {s:'Colega',fr:'Comment vont tes enfants ?',tr:'¿Cómo están tus chamos?',side:'right'},
  ...
  {id:'emot2',level:2,emoji:'😄',name:'Les Émotions',sub:'Tristesse, fatigue, joie / Tristeza, cansancio, alegría',type:'dialog',
   situations:[
    ...
    {label:'Sit. 3',title:'Alegría por una buena noticia',img:'🎉',dialogue:[
      ...
      {s:'Amiga',fr:'C\'est fantastique ! Je suis très heureuse pour toi !',tr:'¡Qué chévere! ¡Estoy muy feliz por ti!',side:'right'}
    ]}
   ],
  ...
  {id:'log2',level:2,emoji:'🏠',name:'Le Logement',sub:'Studio, objets, ménage / Apartamento, objetos',type:'dialog',
   situations:[
    {label:'Sit. 1',title:'Visitar un apartamento en alquiler',img:'🏢',dialogue:[
      {s:'Propietario',fr:'Voici le studio. Il y a un salon-cuisine et une salle de bain.',tr:'Este es el apartamento. Tiene sala-cocina y baño.',side:'right'},
   ...
   quiz:[
    {q:'¿Qué significa "Le loyer"?',opts:['El apartamento','El alquiler','El cuarto','El contrato'],ans:1},
  ...
  {id:'veth2',level:2,emoji:'👗',name:'Les Vêtements',sub:'Matin, taille, veste perdue / Mañana, talla, ropa perdida',type:'dialog',
   situations:[
    ...
    {label:'Sit. 3',title:'Buscar una chaqueta perdida',img:'🔍',dialogue:[
      ...
      {s:'Mesonero',fr:'De quelle couleur est-elle ?',tr:'¿De qué color es?',side:'right'},
      {s:'Carlos',fr:'Elle est noire, avec une fermeture éclair.',tr:'Es negra, con cremallera.',side:'left'},
      {s:'Mesonero',fr:'Attendez... voilà une veste noire.',tr:'Espere... aquí hay una chaqueta negra.',side:'right'},
      {s:'Carlos',fr:'Oui c\'est la mienne ! Merci beaucoup !',tr:'¡Sí, esa es la mía! ¡Muchísimas gracias!',side:'left'}
    ]}
   ],
   vocab:['La veste = La chaqueta','Le manteau = El abrigo','La taille = La talla','Les chaussures = Los zapatos','La cabine d\'essayage = El probador','Il fait froid = Hace frío'],
   quiz:[
  ...
  {id:'anim2',level:2,emoji:'🐘',name:'Les Animaux',sub:'Mascotte, rue, ferme / Mascota, calle, finca',type:'dialog',
   situations:[
    {label:'Sit. 1',title:'Hablar de tu mascota',img:'🐶',dialogue:[
      ...
      {s:'Luisa',fr:'Il a trois ans. Il est très gentil.',tr:'Tiene tres años. Es muy buenísimo.',side:'left'},
   ...
   vocab:['Le chien = El perro','Le chat = El gato','La vache = La vaca','La poule = La gallina','Le cheval = El caballo','Il est doux = Es manso / tranquilo','La ferme = La finca / la granja'],
   quiz:[
    {q:'¿Qué significa "Il est doux" (hablando de un animal)?',opts:['Es feo','Es manso','Es agresivo','Es grande'],ans:1},
    {q:'¿Cómo se dice "La finca / la granja" en francés?',opts:['Le jardin','La forêt','La ferme','Le champ'],ans:2},
  ...
  {id:'pays2',level:2,emoji:'🌍',name:'Les Pays',sub:'Nationalité, vacances, rêves / Nacionalidad, vacaciones',type:'dialog',
   situations:[
    {label:'Sit. 1',title:'Preguntar la nacionalidad',img:'🗺️',dialogue:[
      ...
      {s:'Ana',fr:'Je viens du Venezuela. Et vous ?',tr:'Soy de Venezuela. ¿Y usted?',side:'left'},
  ...
  {id:'plan2',level:2,emoji:'🌿',name:'Les Plantes',sub:'Fleuriste, maison, parc / Floristería, casa, parque',type:'dialog',
   situations:[
    ...
    {label:'Sit. 2',title:'Regar las plantas de la casa',img:'🪴',dialogue:[
      {s:'Vecina',fr:'Tu peux arroser mes plantes cette semaine ?',tr:'¿Puedes regar mis matas esta semana?',side:'right'},
      ...
      {s:'Luisa',fr:'D\'accord, je mets la plante près de la fenêtre.',tr:'Bueno, pongo la mata cerca de la ventana.',side:'left'}
    ]},
   ...
   vocab:['La fleur = La flor','L\'arbre = El árbol','La rose = La rosa','La feuille = La hoja','Arroser = Regar','Le jardin = El jardín / la mata','Le bouquet = El ramo'],
   quiz:[
  ...
  {id:'met2',level:2,emoji:'💼',name:'Les Professions',sub:'Demander, expliquer, rêver / Preguntar, explicar, soñar',type:'dialog',
   situations:[
    ...
    {label:'Sit. 2',title:'Hablar del trabajo actual',img:'💻',dialogue:[
      ...
      {s:'María',fr:'Non, vingt minutes en bus. J\'aime beaucoup mon travail.',tr:'No, veinte minutos en autobús. Me encanta mi trabajo.',side:'left'}
    ]},
    {label:'Sit. 3',title:'El trabajo de los sueños',img:'🌟',dialogue:[
      ...
      {s:'Profe',fr:'C\'est un beau métier ! Et toi, Luisa ?',tr:'¡Qué bello oficio! ¿Y tú, Luisa?',side:'right'},
  ...
  {id:'lieux2',level:2,emoji:'🏙️',name:'Les Lieux Importants',sub:'Urgence, courses, campagne / Lugares importantes',type:'dialog',
   ...
   vocab:['La pharmacie = La farmacia','L\'hôpital = El hospital','Le supermarché = El supermercado / el súper','La banque = El banco','La campagne = El campo','La rivière = El río / la quebrada','La mairie = La alcaldía'],
   quiz:[
  ...
  {id:'orient2',level:2,emoji:'🧭',name:'S\'Orienter',sub:'Chemin, taxi, magasin / Camino, taxi, tienda',type:'dialog',
   situations:[
    ...
    {label:'Sit. 3',title:'Indicar dónde está una tienda',img:'🏪',dialogue:[
      ...
      {s:'Luisa',fr:'Non, c\'est très près, deux minutes à pied.',tr:'No, está muy cerca, a dos minutos a pie.',side:'left'}
    ]}
   ],
  ...
  {id:'sante2',level:2,emoji:'🏥',name:'La Santé',sub:'Médecin, symptômes, pharmacie / Médico, síntomas',type:'dialog',
   situations:[
    ...
    {label:'Sit. 2',title:'Explicar los síntomas al médico',img:'🩺',dialogue:[
      ...
      {s:'Médico',fr:'Non, c\'est une angine. Je vous fais une ordonnance.',tr:'No es grave, es una amigdalitis. Le hago una receta.',side:'right'}
    ]},
    {label:'Sit. 3',title:'Comprar medicamentos en la farmacia',img:'💊',dialogue:[
      ...
      {s:'Farmaceuta',fr:'Bonjour. Voici les médicaments. Prenez-en un le matin et un le soir.',tr:'Buenos días. Aquí tiene las medicinas. Tome una en la mañana y una en la noche.',side:'right'},
   ...
   vocab:['Un rendez-vous = Una cita médica','L\'ordonnance = La receta médica','Le médicament = El medicamento / la medicina','J\'ai mal à... = Me duele...','La fièvre = La fiebre','La toux = La tos','Le pharmacien = El/la farmaceuta'],
   quiz:[
  ...
  {id:'objets2',level:2,emoji:'🔑',name:'Objets du Quotidien',sub:'Clés, stylo, chargeur / Llaves, bolígrafo, cargador',type:'dialog',
   situations:[
    {label:'Sit. 1',title:'Buscar las llaves antes de salir',img:'🔍',dialogue:[
      ...
      {s:'Ana',fr:'Tu as regardé dans ton sac à dos ?',tr:'¿Revisaste en tu morral?',side:'right'},
    ...
    {label:'Sit. 2',title:'Pedir prestado un bolígrafo o papel',img:'✏️',dialogue:[
      {s:'Luisa',fr:'Excuse-moi, tu aurais un stylo à me prêter ?',tr:'Disculpa, ¿me puedes prestar un bolígrafo?',side:'left'},
   ...
   vocab:['Les clés = Las llaves','Le portefeuille = La billetera','Le sac à dos = La mochila / el morral','Le stylo = El bolígrafo / el lapicero','La feuille = La hoja de papel','Le chargeur = El cargador','Les lunettes = Los lentes'],
   quiz:[
