/* ========================================
   Français → Español Ecuador 🇫🇷 – Logique applicative
...
var done=[];
function loadDone(){try{done=JSON.parse(localStorage.getItem('pf_ec_done_v1')||'[]');}catch(e){done=[];}}
function saveDone(){try{localStorage.setItem('pf_ec_done_v1',JSON.stringify(done));}catch(e){}}
...
function renderFlash(){
  ...
  document.getElementById('tabContent').innerHTML=
    ...
    +'<div class="fc-front">'+emFr+'<div class="fc-front-word">'+card.fr+'</div><div class="fc-front-hint">👆 Toca para ver la traducción</div></div>'
