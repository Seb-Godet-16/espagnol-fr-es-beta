 ...
 * ║  "FR" / "OR" désigne la LANGUE D'INTERFACE de l'apprenant, pas  ║
 * ║  la langue apprise : un francophone qui apprend l'oromo charge  ║
 * ║  ALL_THEMES_OR (menus en français, vocabulaire ciblé = oromo).  ║
 * ╠══════════════════════════════════════════════════════════════════╣
...
/* ══════════════════════════════════════════════════════════════════
   §5 — TABLEAUX FUSIONNÉS (consommés directement par app.js)
   ──────────────────────────────────────────────────────────────────
   initApp() choisit l'un des deux tableaux ci-dessous selon le
   mode choisi par l'utilisateur sur l'écran de lancement :
     • mode 'learn_french' → ALL_THEMES = ALL_THEMES_FR
     • mode 'learn_oromo'  → ALL_THEMES = ALL_THEMES_OR
   ══════════════════════════════════════════════════════════════════ */
