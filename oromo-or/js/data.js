...
var LEVEL1_THEMES=[
 {id: 'alpha',
  ...
  type: 'alpha',
  words: [
    {es: 'A', fr: 'a (court ou long comme aa)', em: '✈️'},
    {es: 'B', fr: 'b', em: '🎈'},
    {es: 'C', fr: 'tchyé (son tch éjectif, ex: caallaa)', em: '☕'},
    {es: 'CH', fr: 'tch (comme en français)', em: '🐱'},
    {es: 'D', fr: 'd', em: '💃'},
    {es: 'DH', fr: 'd implosif (son unique produit en aspirant l\'air)', em: '💧'},
    {es: 'E', fr: 'é', em: '🏫'},
    {es: 'F', fr: 'f', em: '🌸'},
    {es: 'G', fr: 'g (toujours dur comme dans gâteau)', em: 'Station'},
    {es: 'H', fr: 'h (toujours expiré et bien prononcé)', em: '🏨'},
    {es: 'I', fr: 'i', em: '🏝️'},
    {es: 'J', fr: 'dj (comme le j anglais, ex: djembé)', em: '🌿'},
    {es: 'K', fr: 'k', em: '⚖️'},
    {es: 'L', fr: 'l', em: '🦁'},
    {es: 'M', fr: 'm', em: '🏠'},
    {es: 'N', fr: 'n', em: '🌙'},
    {es: 'NY', fr: 'gny (comme le gn français de "gagner")', em: '🎵'},
    {es: 'O', fr: 'o', em: '🐦'},
    {es: 'P', fr: 'p', em: '🍞'},
    {es: 'PH', fr: 'p éjectif (p suivi d\'une petite expulsion d\'air)', em: '💊'},
    {es: 'Q', fr: 'k éjectif (son glottal produit à l\'arrière de la gorge)', em: '🏘️'},
    {es: 'R', fr: 'r (toujours roulé)', em: '🌹'},
    {es: 'S', fr: 's (toujours dur, ne se prononce jamais z)', em: '☀️'},
    {es: 'SH', fr: 'ch (comme le ch français)', em: '🐑'},
    {es: 'T', fr: 't', em: '🚂'},
    {es: 'U', fr: 'ou', em: '1️⃣'},
    {es: 'V', fr: 'v (très rare, mots empruntés uniquement)', em: '🌆'},
    {es: 'W', fr: 'w (comme le ou de "oui")', em: '🚃'},
    {es: 'X', fr: 't éjectif (son t percutant produit avec la langue)', em: '🔨'},
    {es: 'Y', fr: 'y (comme le y de "yaourt")', em: '🥛'},
    {es: 'Z', fr: 'z (très rare, uniquement pour les emprunts)', em: '0️⃣'}
  ],
  quiz10: [
  ...
  {id:'pres',level:1,emoji:'🙋',name:'Ofii Beeksisuu',sub:'Maqaa, dachee, magaalaa… / Se présenter',
   words:[
    ...
    {es:'Faransaawi / Faransaawitii',fr:'Français(e)',em:'🇫🇷'},{es:'Oromoo / Itoophiyaanitti',fr:'Espagnol(e)',em:'🇪🇹'},
...
{id:'num',level:1,emoji:'🔢',name:'Lakkoofsa',sub:'Zeerroo irraa hanga kuma lamaa / Zéro à deux mille',
 words:[
  ...
  {es:'Dhibba / Dhibbaa',fr:'Cent (ciento devant un nombre : ciento veinte = 120)',em:'1️⃣0️⃣0️⃣'},
  {es:'Dhibba lama',fr:'Deux cents (genre : doscientas personas)',em:'2️⃣0️⃣0️⃣'},
  {es:'Dhibba sadii',fr:'Trois cents (genre : trescientas personas)',em:'3️⃣0️⃣0️⃣'},
  {es:'Dhibba afur',fr:'Quatre cents (genre : cuatrocientas personas)',em:'4️⃣0️⃣0️⃣'},
  {es:'Dhibba shan',fr:'Cinq cents (genre : quinientas personas)',em:'5️⃣0️⃣0️⃣'},
  {es:'Dhibba jaha',fr:'Six cents (genre : seiscientas personas)',em:'6️⃣0️⃣0️⃣'},
  {es:'Dhibba torba',fr:'Sept cents (genre : setecientas personas)',em:'7️⃣0️⃣0️⃣'},
  {es:'Dhibba saddeet',fr:'Huit cents (genre : ochocientas personas)',em:'8️⃣0️⃣0️⃣'},
  {es:'Dhibba sagal',fr:'Neuf cents (genre : novecientas personas)',em:'9️⃣0️⃣0️⃣'},
  {es:'Kuma',fr:'Mille',em:'1️⃣0️⃣0️⃣0️⃣'},
  {es:'Kuma lama',fr:'Deux mille (mil est invariable)',em:'2️⃣0️⃣0️⃣0️⃣'}
 ],
   quiz10:[
  ...
  {id:'col',level:1,emoji:'🎨',name:'Halluu',sub:'Diimaa, magariisa, keelloo… / Les couleurs',
   words:[
    ...
    {es:'Daallatii / Diimtuuja',fr:'Violet (morado=foncé, violeta=clair)',em:'💜'},{es:'Bunii',fr:'Marron',em:'🤎'},
...
{id:'viaje',level:1,emoji:'🧳',name:'Deemsa',sub:'Baggaajii, hooteela, paaspoortiifi… / Le voyage',
 ...
 words:[
  ...
  {id:'verb',level:1,emoji:'📝',name:'Yakkawwan',sub:'Ta\'uu, qabaachuu, deemuu… / Les verbes principaux',
   words:[
   {es:'Ta\'uu / Jiraachuu',fr:'Être (ser=permanent : soy francés / estar=temporaire : estoy cansado)',em:'🧑',conj:{es:['Ani nan ta\'a / jira','Ati ni ta\'a / jirta','Inni/Isheen ni ta\'a / jira','Nuti ni taana / jirra','Isin ni taastu / jirtu','Isaan ni ta\'u / jiru'],fr:['Je suis','Tu es','Il/Elle est','Nous sommes','Vous êtes','Ils/Elles sont']}},
  ...
  {id:'sante',level:1,emoji:'🏥',name:'Fayyaa',sub:'Doktora, farmaasiitii… / La santé',
   words:[
    {es:'Dhukkubbii / Nan dhukkuba',fr:'Faire mal / j\'ai mal (me duele la cabeza = j\'ai mal à la tête)',em:'🤕'},
...
var LEVEL2_THEMES = [
  ...
  {id:'salut2',level:2,emoji:'👋',name:'Nagaa gaafachuu',sub:'Saluer quelqu\'un / Dire bonjour en Oromia',type:'dialog',
   ...
   quiz:[
    {q:'Maallaqni "Jiddu jiddu" maal jechuudha?',opts:['Très bien','Très mal','Comme ci comme ça','Je suis fatigué'],ans:2},
    {q:'Afaan Oromootti "Je suis désolé" akkamiin jedha?',opts:['Galatoomi','Dhiifama','Nagaan','Dhiisi'],ans:1},
    {q:'Maallaqni "Haga wal arginu!" maal jechuudha?',opts:['Bonjour !','Merci !','À plus !','S\'il vous plaît !'],ans:2}
   ]},
  ...
  {id:'pres2',level:2,emoji:'🙋',name:'Ofbeeksisuu',sub:'Dire son nom, son pays / Se présenter',type:'dialog',
   ...
   quiz:[
    ...
    {q:'Maallaqni "Lammii kamii?" maal jechuudha?',opts:['Comment tu t\'appelles ?','Quel âge tu as ?','Tu es d\'où ?','Tu habites où ?'],ans:2},
  ...
  {id:'chemin2',level:2,emoji:'🗺️',name:'Karaa gaafachuu',sub:'Demander son chemin / S\'orienter en ville',type:'dialog',
   ...
   quiz:[
    ...
    {q:'Maallaqni "Farmaasinni dhiyotti jiraa?" maal jechuudha?',opts:['La pharmacie est fermée','Il y a une pharmacie près d\'ici ?','Où est la pharmacie ?','La pharmacie est loin ?'],ans:1},
  ...
  {id:'bar2',level:2,emoji:'☕',name:'Kaafee keessatti',sub:'Commander au café oromo / Buna et injera',type:'dialog',
   ...
   quiz:[
    ...
    {q:'Maallaqni "Kafaltii, maaloo" maal jechuudha?',opts:['Le menu, s\'il vous plaît','L\'addition, s\'il vous plaît','Un café, s\'il vous plaît','L\'eau, s\'il vous plaît'],ans:1},
  ...
  {id:'resto2',level:2,emoji:'🍽️',name:'Mana nyaataa keessatti',sub:'Commander un repas / Au restaurant en Oromia',type:'dialog',
   ...
   quiz:[
    ...
    {q:'Maallaqni "Foon malee" maal jechuudha?',opts:['Avec de la viande','Sans poisson','Sans viande','Avec du poulet'],ans:2}
   ]},
  ...
  {id:'compras2',level:2,emoji:'🛍️',name:'Bitachuu',sub:'Acheter des choses / Faire ses courses',type:'dialog',
   ...
   quiz:[
    ...
    {q:'Maallaqni "Kan biraa hoo?" maal jechuudha?',opts:['C\'est tout ?','Autre chose ?','Vous avez ça ?','C\'est combien ?'],ans:1},
  ...
  {id:'transp2',level:2,emoji:'🚌',name:'Geejjiba fayyadamuu',sub:'Prendre le bus et les transports / Se déplacer',type:'dialog',
   ...
   quiz:[
    ...
    {q:'Maallaqni "Buufata" maal jechuudha?',opts:['Le billet','La ligne','L\'arrêt','Le quai'],ans:2},
  ...
  {id:'hotel2',level:2,emoji:'🏨',name:'Hootelatti',sub:'Arriver à l\'hôtel / S\'installer',type:'dialog',
   ...
   quiz:[
    ...
    {q:'Maallaqni "Hin hojjetu" maal jechuudha?',opts:['C\'est fermé','Ça ne marche pas','C\'est cassé','Je ne sais pas'],ans:1},
  ...
  {id:'medico2',level:2,emoji:'🩺',name:'Doktoratti',sub:'Expliquer ce qui ne va pas / Chez le médecin',type:'dialog',
   ...
   quiz:[
    ...
    {q:'Maallaqni "Qoonqoon natti dhukkuba" maal jechuudha?',opts:['J\'ai mal à la tête','J\'ai mal au ventre','J\'ai mal à la gorge','J\'ai mal au dos'],ans:2},
  ...
  {id:'meteo2',level:2,emoji:'☀️',name:'Qilleensa',sub:'Parler de la météo / Qu\'est-ce qu\'il fait ?',type:'dialog',
   ...
   quiz:[
    ...
    {q:'Maallaqni "Ho\'aa baay\'ee!" maal jechuudha?',opts:['Quelle chance !','Quelle chaleur !','Quel froid !','Quel vent !'],ans:1},
  ...
  {id:'logement2',level:2,emoji:'🏠',name:'Mana barbaaduu',sub:'Chercher un logement / Louer une maison',type:'dialog',
   ...
   quiz:[
    {q:'Maallaqni "Gatiin addaadha" maal jechuudha?',opts:['Tout compris','Les charges sont incluses','Les charges sont en plus','C\'est gratuit'],ans:2},
    {q:'Afaan Oromootti "Le plombier" akkamiin jedha?',opts:['Ibsaa hojjetaa','Hidhaata bishaan','Muka hojjetaa','Barreessaa'],ans:1},
    {q:'Maallaqni "Kiraa" maal jechuudha?',opts:['La vente','Le loyer','La maison','Le contrat'],ans:1}
   ]},
  ...
  {id:'gustos2',level:2,emoji:'❤️',name:'Jaalala fi filannoowwan',sub:'Parler de ce qu\'on aime / Les loisirs',type:'dialog',
   ...
   quiz:[
    ...
    {q:'Maallaqni "Maal dhiyeessaa?" siinimaa keessatti maal jechuudha?',opts:['Ça coûte combien ?','À quelle heure ?','Qu\'est-ce qu\'il y a ?','C\'est où ?'],ans:2},
  ...
  {id:'fiesta2',level:2,emoji:'🎉',name:'Halkan bahu',sub:'Sortir le soir / Vie sociale en Oromia',type:'dialog',
   ...
   quiz:[
    {q:'Maallaqni "Tolee!" Oromiyaatti maal jechuudha?',opts:['Au revoir !','Allons-y !','D\'accord !','C\'est nul !'],ans:2},
    {q:'Afaan Oromootti "J\'ai faim" akkamiin jedha?',opts:['Dheebuu dhabe','Rafuu barbaada','Qorraa dhabe','Beela\'ee jira'],ans:3},
    {q:'Maallaqni "Oromiyaatti halkan bahu" maal jechuudha?',opts:['En Oromia on rentre tard','En Oromia on travaille tard','En Oromia on sort tard','En Oromia on mange tard'],ans:2}
   ]}
